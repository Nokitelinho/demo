...
import com.ibsplc.neoicargo.mailmasters.errorhandling.exception.MailHHTBusniessException;
...
public class MailTrackingBusinessException extends BusinessException {
	...
	*/
	public static String returnErrorMapping(String value) {
		...
		errorMapping.put(MailTrackingBusinessException.MAILTRACKING_CONTAINERALREADYARRIVEDONE,
				"mailtracking.defaults.err.containerAlreadyArrived");
		errorMapping.put(MailTrackingBusinessException.MAILTRACKING_TBATBCCANFLIGHTHHT,
				"The Flight is in To be actioned/To be cancelled/cancelled status");
		errorMapping.put(MailTrackingBusinessException.MAILTRACKING_TBATBCCANFLIGHT,
				"The Flight is in To be actioned/To be cancelled/cancelled status");
		...
		errorMapping.put(MailTrackingBusinessException.MAILTRACKING_INVALIDFLIGHT,
