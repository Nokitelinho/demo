package com.ibsplc.neoicargo.mailmasters.errorhandling.exception;
...
public class MailHHTBusniessException extends BusinessException {
	...
	public static final String NOT_A_COTERMINUSAIRPORT = "Invalid delivery  airport";
	...
	public static final String INVALIDACPAIRPOT_RCV_FRM_TRUCK_WARNING = "Invalid acceptance airport";
	...
	public static final String IMPORT_FLIGHT_MANDATORY = "Import flight details are mandatory for mailbag arrival";
	public static final String OOE_NOT_CONFIGURED_FOR_GPA_AGAINST_ORG = "Office of Exchange is not configured for GPA against Airport";
	public static final String DOE_NOT_CONFIGURED_FOR_GPA_AGAINST_DEST = "Office of Exchange is not configured for GPA against Airport";
	public static final String RETURN_NOT_POSSIBLE_AT_THIS_PORT = "Return is not possible from this port";
	public static final String RETURN_NOT_POSSIBLE_AT_DEST = "Return is not possible from Destination or its Co-Terminus port";
	public static final String OFFLOAD_OF_ULD_AS_BARROW_NOT_POSSIBLE = "Manifested trolley/barrow cannot be offloaded";
	public static final String ULD_AS_BULK_IN_SAME_CONTAINER = "ULD is already available in the flight with different container type";
	...
	public static final String INVALID_CONTAINERLEVEL_FOR_ARR_OR_DLV = "The container contains mailbags already undergone inbound transactions";
