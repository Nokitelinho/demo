...
public class OutboundLyinglistFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	*/
	public OutboundLyinglistFilterQuery(OutboundCarditGroupMapper groupMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, boolean summary) {
		super(mailbagEnquiryFilterVO.getTotalRecords(), groupMapper, PersistenceController.getEntityManager().currentSession());
		this.baseQuery = baseQuery;
		this.mailbagEnquiryFilterVO = mailbagEnquiryFilterVO;
		this.summary = summary;
	}

	public OutboundLyinglistFilterQuery(OutboundCarditSummaryMapper summaryMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, boolean summary) {
		super(mailbagEnquiryFilterVO.getTotalRecords(), summaryMapper,PersistenceController.getEntityManager().currentSession());
		this.baseQuery = baseQuery;
		this.mailbagEnquiryFilterVO = mailbagEnquiryFilterVO;
		this.summary = summary;
	}
	...
	*/
	public OutboundLyinglistFilterQuery(OutboundCarditGroupMapper groupMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, String fromScreen) {
		super(mailbagEnquiryFilterVO.getPageSize(), -1, groupMapper,PersistenceController.getEntityManager().currentSession());
		this.baseQuery = baseQuery;
		this.mailbagEnquiryFilterVO = mailbagEnquiryFilterVO;
	}

	public OutboundLyinglistFilterQuery(OutboundCarditGroupMapper groupMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, boolean summary, int pageSize) {
		super(pageSize, -1, groupMapper,PersistenceController.getEntityManager().currentSession());
		this.baseQuery = baseQuery;
		this.mailbagEnquiryFilterVO = mailbagEnquiryFilterVO;
		this.summary = summary;
	}
	public String getNativeQuery() {
		log.debug("Inside the AcceptedMailBagFilterQuery",
				"getNativeQuery()");
...
//		}
		...
		if (scanFromDate != null ) {
			...
			this.setParameter(++index, Integer.parseInt(scanFromDate.format(DateTimeFormatter.ofPattern(MailConstantsVO.YYYY_MM_DD))));
		...
		if (scanToDate != null ) {
			...
			this.setParameter(++index, Integer.parseInt(scanToDate.format(DateTimeFormatter.ofPattern(MailConstantsVO.YYYY_MM_DD))));
		}
		...
		if(flightDate!=null){
			...
			this.setParameter(++index, flightSqlDate.format(DateTimeFormatter.ofPattern(MailConstantsVO.YYYY_MM_DD)));
		}
