...
public class OutboundLyingListAcceptedFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	*/
	public OutboundLyingListAcceptedFilterQuery(OutboundCarditGroupMapper groupMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, String outerQuery, boolean summaryFlag) {
	...
	*/
	public OutboundLyingListAcceptedFilterQuery(OutboundCarditSummaryMapper summaryMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, String outerQuery, boolean summaryFlag) {
