...
public class OffloadedMailBagFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	*/
	public OffloadedMailBagFilterQuery(MailbagMapper mailbagMapper, MailbagEnquiryFilterVO mailbagEnquiryFilterVO,
			String baseQuery) {
	...
	public String getNativeQuery() {
		 ...
		 */
			...
			upliftedQuery.append("WITH HIS AS (SELECT CMPCOD, MALSEQNUM, MALHISIDR, FLTCARCOD, FLTCARIDR, ")
					...
					.append(" MST.DMGFLG, MST.LSTUPDTIM , MST.FLTNUM, MST.FLTSEQNUM, MST.FLTCARIDR, MST.SEGSERNUM, ")
					.append(" MST.VOl,MST.VOLUNT,MST.ORGCOD, MST.DSTCOD,MST.REQDLVTIM, HIS.FLTCARCOD, ")
