...
/** 
 * @author a-1936This class is used to append the Query dynamically 
 */
public class OffloadMailBagsFilterQuery extends NativeQuery {
	...
	*/
	public OffloadMailBagsFilterQuery(OffloadFilterVO offloadFilterVO, String baseQuery) {
