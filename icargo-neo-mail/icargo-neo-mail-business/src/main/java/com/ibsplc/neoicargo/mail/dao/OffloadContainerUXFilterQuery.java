...
public class OffloadContainerUXFilterQuery extends PageableNativeQuery<ContainerVO> {
	...
	public OffloadContainerUXFilterQuery(int pageSize, int totalRecords,
										 OffloadContainerMultiMapper offloadContainerMultiMapper, String baseQuery, OffloadFilterVO offloadFilterVO,
										 Query offloadContainerquery) {
		super(pageSize, totalRecords, offloadContainerMultiMapper, PersistenceController.getEntityManager().currentSession());
		log.debug("OffloadContainerUXFilterQuery" + " : " + "constructor" + " Entering");
	...
	public String getNativeQuery() {
		...
		if (MailConstantsVO.ALL.equals(containerType)
			...
			builder
					...
					.append(" MST.POACOD,MST.ULDFULIND,MST.FLTCARCOD,SEG.ULDNUM,ASG.FLTDAT,MST.ULDFULIND ");
		...
		if (MailConstantsVO.ALL.equals(containerType)
			...
			builder
					.append(" group by MST.CMPCOD,MST.CONNUM,MST.ASGPRT,MST.FLTCARIDR,MST.FLTNUM,MST.FLTSEQNUM,MST.LEGSERNUM,")
					.append(" MST.ACPFLG,MST.POAFLG,MST.SEGSERNUM,MST.CONTYP,MST.POU,MST.DSTCOD,MST.CONJRNIDR," )
					.append(" MST.POACOD,MST.ULDFULIND,MST.FLTCARCOD,CONSEG.ULDNUM,ASG.FLTDAT,MST.ULDFULIND ");
