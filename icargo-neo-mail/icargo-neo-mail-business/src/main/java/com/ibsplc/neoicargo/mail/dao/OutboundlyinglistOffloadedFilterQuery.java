...
public class OutboundlyinglistOffloadedFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	*/
	public OutboundlyinglistOffloadedFilterQuery(OutboundCarditGroupMapper groupMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, boolean summaryFlag) {
	...
	*/
	public OutboundlyinglistOffloadedFilterQuery(OutboundCarditSummaryMapper summaryMapper,
			MailbagEnquiryFilterVO mailbagEnquiryFilterVO, String baseQuery, boolean summaryFlag) {
	...
	public String getNativeQuery() {
		...
		log.debug("The Damage Status ", damageFlag);
		/*
		...
		if (MailConstantsVO.MAIL_STATUS_OFFLOADED.equals(currentStatus)){
			log.debug("Constructing the Offloaded Query");
			...
			if (carditPresent != null
				...
				log.debug( "The carditPresent flag is ", carditPresent);
			 ...
			 */
			if (isTransitFlag) {
				log.debug("The Transit flag is ", isTransitFlag);
		...
		/*if (MailConstantsVO.MAIL_STATUS_NOTUPLIFTED.equals(currentStatus)) {
	      ...
	      if (scanToDate != null) {
			...
			if (MailConstantsVO.MAIL_STATUS_OFFLOADED.equals(currentStatus)) {
				...
				log.debug( "THE STATUS IS OFFLOADED");
			}
