...
public class MailbagHistoryMapper implements Mapper<MailbagHistoryVO> {
	...
	public MailbagHistoryVO map(ResultSet rs) throws SQLException {
		...
		mailbagHistoryVO.setWeight(quantities.getQuantity(Quantities.MAIL_WGT, BigDecimal.valueOf(rs.getDouble("WGT"))));//added by A-7371
		...
		mailbagHistoryVO.setActualWeight(quantities.getQuantity(Quantities.MAIL_WGT, BigDecimal.valueOf(rs.getDouble("ACTWGT"))));
