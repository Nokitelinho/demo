...
/** 
 * Java file	: 	com.ibsplc.icargo.business.mail.operations.MailMLDBusniessException.java Version		:	Name	:	Date			:	Updation --------------------------------------------------- 0.1		:	A-4803	:	07-Nov-2014	:	Draft
 * @author A-4803
 */
public class MailMLDBusniessException extends BusinessException {
	...
	*/
	...
	public static final String ULDBULK_ANOTHER_FLIGHT = "mailtracking.defaults.uldbulkpresentinanotherflight";
	/** 
	...
	*/
	...
	public static final String MAILTRACKING_DEFAULTSTORAGEUNITNOTASSIGNEDTOFLIGHT = "mailtracking.defaults.defaultstorageunit";
	/** 
	...
	*/
	public static final String MAILBAG_ALREADY_OFFLOADED_EXCEPTION = "mailtracking.defaults.alreadyoffloaded";
	/** 
	* The Constant MAILBAG_NOT_AVAILABLE_EXCEPTION. 
	*/
	public static final String MAILBAG_NOT_AVAILABLE_EXCEPTION = "mailtracking.defaults.mailbagunavailable";
	/** 
	* The Constant MAILBAG_ALREADY_TRANSFERRED_EXCEPTION. 
	*/
	public static final String MAILBAG_ALREADY_TRANSFERRED_EXCEPTION = "mailtracking.defaults.mailbagtransferred";
	/** 
	...
	*/
	public static final String INVALID_MAIL_CATEGORY_EXCEPTION = "mailtracking.defaults.mld.invalidcategory";
	/** 
	...
	*/
	public static final String INVALID_OFFLOAD_FROM_PA_BUILT_ULD = "mailtracking.defaults.mld.invalidoffload";
	/** 
