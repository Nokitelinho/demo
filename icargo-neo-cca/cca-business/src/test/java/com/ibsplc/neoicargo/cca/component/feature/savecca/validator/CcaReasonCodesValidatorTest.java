...
class CcaReasonCodesValidatorTest {

    private CCAMasterVO ccaMasterVO;

    @InjectMocks
    private CcaReasonCodesValidator validator;
    ...
    @Test
    void shouldThrowExceptionWhenReasonCodesEmpty() {
        // Given
        ccaMasterVO.setCcaReason("");
    ...
    void shouldNotThrowException() {
        // Given
        ccaMasterVO.setCcaReason("VD,KD");
