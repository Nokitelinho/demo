...
public class ReopenAwbPersistorTest {
    ...
    public void shouldReopenAwb() {
        ...
        Assertions.assertEquals(AwbStatusEnum.REOPENED.getValue(), awbArgumentCaptor.getValue().getAwbStatus());
    }

    @Test
    public void shouldNotReopenAwb() {
        //given
        var shipmentPrefix = "134";
        var masterDocumentNumber = "789040";
        var shipmentKey = new ShipmentKey(shipmentPrefix, masterDocumentNumber);
        ...
        //when
        reopenAwbPersistor.persist(trackingAWBMasterValidationVO);
