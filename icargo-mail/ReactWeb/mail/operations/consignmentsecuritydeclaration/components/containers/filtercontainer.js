...
const mapStateToProps = (state) => {
      return {
            ...
            initialValues:{ consignDocNo: state.filterpanelreducer.navigationFilter, paCode:state.filterpanelreducer.paCode},
            ...
            csgIssuerName:state.filterpanelreducer.csgIssuerName?state.filterpanelreducer.csgIssuerName:''
      }
