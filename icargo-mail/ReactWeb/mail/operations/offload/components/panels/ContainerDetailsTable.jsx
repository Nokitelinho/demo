...
import ContainerTableHeaderPanel from './ContainerTableHeaderPanel.jsx'
            ...
            <Fragment>
                <ITable
                    ...
                    customHeader={{
                        ...
                        customPanel: <ContainerTableHeaderPanel  />,
                        "pagination": { "page": this.props.containers, getPage: this.props.getNewPage },
                        filterConfig: {
                            panel: <ContainerTableFilter oneTimeValues={this.props.oneTimeValues} tableFilter={this.props.tableFilter} initialValues={this.props.initialValues} />,
                            title: 'Filter',
                    ...
                    <Columns>
                        ...
                        <Cell>
                            ...
                            <RowCell>
                                {(cellProps) => (
                                    <Content>
                                          <ISelect name={`${cellProps.rowIndex}.offloadReason`}  options={offloadReason}  onBlur={()=>this.offloadReason(cellProps.rowIndex)} />
                                    </Content>)
                                }
                            </RowCell>
                        </Cell>
                        ...
                        >
                            <Cell>
                                ...
                                <RowCell>
                                    {(cellProps) => (
                                        <Content> 
                                            <ITextField  name={`${cellProps.rowIndex}.remarks`}  mode="edit" type="text" uppercase={true} />
                                        </Content>)
                                    }
                                </RowCell>
                            </Cell>
