...
export class CarditTabPanel extends Component {
    constructor(props) {
        super(props)
    }
    ...
    render() {
        let active = 0;
        if (this.props.activeCarditTab === 'GROUP_VIEW') {
            active = 0;
        } else {
            active = 1;
        }
            ...
            <Row>
                ...
                {this.props.activeCarditTab === 'LIST_VIEW' &&
                    <Col sm="24" md="24" lg="24">
                        <ICustomHeaderHolder tableId='carditlisttable' />
                    </Col>
                }
                {this.props.activeCarditTab === 'GROUP_VIEW' &&
                    <Col sm="24" md="24" lg="24">
                        <ICustomHeaderHolder tableId='carditgrouptable' />
                    </Col>
                }
            </Row>
        );
