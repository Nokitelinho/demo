...
class ReassignFlightPanel extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.flightDetails !== this.props.flightDetails && this.props.flightDetails && this.props.flightDetails.length > 0) {
            setTimeout(
                () => {
    ...
    reassignSave = () => {
        this.props.reassignContainerToFlightAction(this.props.flightDisplayPage,this.props.defaultPageSize);
    }
    ...
    onlistDetails = () => {
        this.props.listFlightDetailsForReassign();
    }
    ...
    render() {
        ...
        return (
            ...
            <Fragment>
                        ...
                        <Row>
                            ...
                            <Col xs="4">
                                <div className="form-group">
                                    ...
                                    <Lov name="dest" lovTitle="uplift airport" componentId='CMP_MAIL_OPERATIONS_MAILOUTBOUND_DESTINATION' dialogWidth="600" dialogHeight="520" actionUrl="ux.showAirport.do?formCount=1" uppercase={true} />
                                </div>
                            </Col>
                            <Col>
                                <div className="mar-t-md">
                                    ...
                                    <IButton category="secondary" bType="CLEAR" accesskey="C" onClick={this.props.clearReassignFlightPanel} class="btn btn-default">Clear</IButton>{' '}
                                </div>
                            </Col>
                        </Row>
                    </div>
                    <div>
                        <IAccordion>
                            <IAccordionItem expanded>
                                ...
                                <IAccordionItemBody>
                                    <div className={style} style={{ height: "216px" }}>
                                        <ITable
                                            ____scrollToIndex={0}
                                            customHeader={{
                                            ...
                                            registerChild={this.setTableRef}
                                        >
                                                                ...
                                                                return <Content>
                                                                    <DataDisplay index={cellProps.rowIndex} id='flightNumber' label='Flight Number' className="align-items-center d-flex mar-b-2xs" sortByItem={true}>
                                                                        ...
                                                                        {(cellProps.rowData.dcsinfo ==='AFMPROREJ'  ||  cellProps.rowData.dcsinfo ==='AFMFINREJ' || cellProps.rowData.dcsinfo ==='AFMAMDFINREJ' ) ?
                                                                           <span className="badge badge-pill light badge-error" >{dcsStat.label}</span>
                                                                        :''}
                                                                       {(cellProps.rowData.dcsinfo ==='AFMFINACK' || cellProps.rowData.dcsinfo ==='AFMAMDFINACK') ? <span className= {"badge badge-pill light badge-active"}>{dcsStat.label}</span>:''}
                                                                        ...
                                                                        {cellProps.rowData.dcsinfo !=null && cellProps.rowData.dcsinfo !='AFMPROREJ' && cellProps.rowData.dcsinfo !='AFMFINREJ' && cellProps.rowData.dcsinfo !='AFMAMDFINREJ' && cellProps.rowData.dcsinfo !='AFMFINACK' && cellProps.rowData.dcsinfo !='AFMAMDFINACK' && 
                                                                        <span className= {"badge badge-pill light badge-info"}>{dcsStat ? dcsStat.label:''}</span>}
                                             </DataDisplay>
                                                                    <div className="mar-b-2xs">
                                                                        ...
                                                                        <DataDisplay index={cellProps.rowIndex} id='flightDate' label='Flight Date' sortByItem={true}>
                ...
                <PopupFooter>
                    <IButton category="primary" bType="SAVE" accesskey="S" onClick={this.reassignSave} className="btn btn-primary">Save</IButton>
...
export default icpopup(wrapForm('reassignContainerToFlight')(ReassignFlightPanel), { title: 'Re-assign to Flight', className: 'modal_990px' })
