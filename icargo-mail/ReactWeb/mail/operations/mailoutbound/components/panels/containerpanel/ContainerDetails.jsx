                ...
                <Row>
                    <Col md="2">
                        <div className="form-group">
                            <ICheckbox name={`${form}.${index}.barrowFlag`} disabled={this.props.uldToBarrowAllow==='N'||!isUldFormatBulk} label="Barrow" />
                        </div>
                    </Col>
                    <Col md="4">
                        <div className="form-group">
                    ...
                    <Col md="3">
                        <div className="form-group">
                            <Lov name={`${form}.${index}.pou`} lovTitle="POU"  componentId='CMP_MAIL_OPERATIONS_MAILOUTBOUND_POU' uppercase={true} dialogWidth="600" dialogHeight="425" actionUrl="ux.showAirport.do?formCount=1" />
                        </div>
                    </Col>
                    <Col md="3">
                        <div className="form-group">
                    ...
                    <Col md="3">
                        <div className="form-group">
                            <ITextField name={`${form}.${index}.actualWeight`}  onKeyPress={commonCompValidations.restrictDecimal} uppercase="true" componentId='CMP_MAIL_OPERATIONS_MAILOUTBOUND_ACTUAL_WEIGHT'/>
                        </div>
                    </Col>
                    <Col md="3">
                        <div className="form-group">
                    ...
                    <Col md="3">
                        <div className="form-group">
                            <ITextField name={`${form}.${index}.remarks`}  componentId='CMP_MAIL_OPERATIONS_MAILOUTBOUND_REMARKS' uppercase="true" />
                        </div>
                    </Col>
                </Row>
            )
