/*
 * CarditNotAcceptedFilterQuery.java Created on Mar 10, 2008
...
public class CarditNotAcceptedFilterQuery extends NativeQuery {
	...
	public String getNativeQuery() {
		log.entering("CarditNotAcceptedFilterQuery", "getNativeQuery");
		...
		if(!"".equals(mailStatusFilterVO.getFlightNumber().trim())&&(mailStatusFilterVO.getFlightNumber()!=null))
	   	...
	   	log.log(Log.FINE, "!!!!!######-->Query Generated After All Filter",
				baseQuery);
				log.exiting("CarditNotAcceptedFilterQuery", "getNativeQuery");
