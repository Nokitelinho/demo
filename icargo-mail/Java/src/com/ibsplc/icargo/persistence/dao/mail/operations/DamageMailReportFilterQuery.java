/*
 * DamageMailReportFilterQuery.java Created on MAR 01,2008
 *
...
public class DamageMailReportFilterQuery extends NativeQuery {
	...
	public String getNativeQuery() {
		...
		LocalDate fromdate = damageMailFilterVO.getFromDate();
		LocalDate toDate = damageMailFilterVO.getToDate();
		...
		LocalDate flightDate=damageMailFilterVO.getFlightDate(); 
		...
		//builder.append(" AND OPRMST.FLTSTA NOT IN ('TBA','TBC','CAN') "); COMMENTED BY MANISH FOR ICRD-95610
		...
		if (flightDate != null ) {
			...
			this.setParameter(++index, flightDate);
		}
		// Modified as part of BUG ICRD-95934 by A-5526 starts
		...
		// Modified as part of BUG ICRD-95934 by A-5526 ends
