/**
 *	Java file	: 	com.ibsplc.icargo.persistence.dao.xaddons.bs.mail.operations.MailBookingFilterQuery.java
 *
 *	Created by	:	a-7779
...
/**
 * Java file : com.ibsplc.icargo.persistence.dao.xaddons.bs.mail.operations.
...
public class MailBookingFilterQuery extends
	 ...
	 *	Constructor	: 	@param mailBookingFilterVO
	 *	Constructor	: 	@param baseQuery
	 *	Constructor	: 	@param fromScreen
	 *	Constructor	: 	@throws SystemException
	 *	Created by	:	A-8164 for mail awb booking pop up
	 *	Created on	:	06-Nov-2019
	 */
	public MailBookingFilterQuery(MailBookingMapper mapper,
            MailBookingFilterVO mailBookingFilterVO, String baseQuery,String fromScreen)
            throws SystemException {
     super(mailBookingFilterVO.getPageSize(),-1,mapper);
     this.mailBookingFilterVO = mailBookingFilterVO;
     this.baseQuery = baseQuery;
	}
