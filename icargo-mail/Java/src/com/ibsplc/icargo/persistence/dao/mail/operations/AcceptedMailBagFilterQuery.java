...
/*
 * AcceptedMailBagFilterQuery.java Created on Jun 15, 2006
 *
...
public class AcceptedMailBagFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	public static final String rankQuery = "SELECT RESULT_TABLE.* , DENSE_RANK() OVER ( ORDER BY RESULT_TABLE.CMPCOD, RESULT_TABLE.MALIDR, RESULT_TABLE.ORGEXGOFC, RESULT_TABLE.DSTEXGOFC,RESULT_TABLE.YER, RESULT_TABLE.DSN, RESULT_TABLE.MALCLS, RESULT_TABLE.MALCTGCOD) RANK FROM (".toString();
	 ...
	 */
	public AcceptedMailBagFilterQuery(
