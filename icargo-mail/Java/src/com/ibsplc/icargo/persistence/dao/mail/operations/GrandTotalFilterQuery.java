/*
 * GrandTotalFilterQuery.java Created on Feb 14, 2018
 *
...
public class GrandTotalFilterQuery extends  NativeQuery {
	...
	public String getNativeQuery() {
		log.entering("GrandTotalFilterQuery", "Inside the NativeQuery");
		   ...
		   if(carditEnquiryFilterVO.getConsignmentDate()!=null)
			{
				...
				setParameter(++index, Integer.parseInt(carditEnquiryFilterVO.getConsignmentDate().toStringFormat(MailConstantsVO.YYYY_MM_DD).substring(0, 8)));			
			}
	...
	/*	if(fromDate!=null)
		...
		setParameter(++index, Integer.parseInt(fromDate.toStringFormat(MailConstantsVO.YYYY_MM_DD).substring(0, 8)));
		setParameter(++index, Integer.parseInt(toDate.toStringFormat(MailConstantsVO.YYYY_MM_DD).substring(0, 8)));	
