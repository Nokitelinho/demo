...
public class OutboundCarditGroupFilterQuery extends PageableNativeQuery<MailbagVO> {
	...
	//Added by A-5220 for ICRD-21098 ends
		...
		public OutboundCarditGroupFilterQuery(OutboundCarditGroupMapper mapper,
				CarditEnquiryFilterVO carditEnquiryFilterVO, String baseQuery1,String baseQuery2)
				throws SystemException {
		...
		public OutboundCarditGroupFilterQuery(OutboundCarditGroupMapper mapper,
				CarditEnquiryFilterVO carditEnquiryFilterVO, String baseQuery1, String baseQuery2, int pageSize) throws SystemException {
			super(pageSize,-1,mapper);
			this.carditEnquiryFilterVO = carditEnquiryFilterVO;
			this.baseQuery1 = baseQuery1;
			this.baseQuery2 = baseQuery2;
		}
		...
		public String getNativeQuery() {
			log.entering("OutboundCarditGroupFilterQuery", "Inside the NativeQuery");
			   ...
			   if(carditEnquiryFilterVO.getConsignmentDate()!=null)
				{
					...
					setParameter(++index, carditEnquiryFilterVO.getConsignmentDate().toSqlDate().toString());			
				}
