/*
 * UnaccountedDespatchCountFilterQuery.java Created on Jan 19, 2007
 *
 ...
 *
 */
public class UnaccountedDespatchCountFilterQuery extends NativeQuery {
	...
	private static final String GROUP_BY_FOR_R1 = new StringBuilder("GROUP BY ")
	.append(" MST.CMPCOD,DTL.CTRCURCOD ").toString(); 
	
	private static final String GROUP_BY_FOR_R2 = new StringBuilder("GROUP BY ")
	.append(" ULD.CMPCOD,ULD.MALRAT,ULD.CURCOD,ULD.ORGEXGOFC,ULD.DSTEXGOFC,ULD.MALCTGCOD,ULD.MALSUBCLS,ULD.YER,ULD.DSN ").toString();  

	private static final String GROUP_BY_For_R1_WithExp = new StringBuilder("GROUP BY ")
	.append(" ULD.CMPCOD,ULD.MALRAT,ULD.CURCOD,ULD.ORGEXGOFC,ULD.DSTEXGOFC,ULD.MALCTGCOD,ULD.MALSUBCLS,ULD.YER,ULD.DSN ").toString();  
	...
	.append(" AND TRUNC(DTL.FLTDAT) BETWEMALMRABLGMSTEN TO_DATE(?, 'DD-MON-YYYY' ) AND TO_DATE (?,'DD-MON-YYYY') ").toString(); 
    ...
    */
    public UnaccountedDespatchCountFilterQuery(String baseQueryForR1,String baseQueryForR1WithExp,String baseQueryForR2,UnaccountedDispatchesFilterVO unaccountedDispatchesFilterVO)
    throws SystemException {
    ...
    public String getNativeQuery() {
    	...
    	if("R1".equalsIgnoreCase(unaccountedDispatchesFilterVO.getReasonCode())){
			...
			filterQuery.append(GROUP_BY_FOR_R1);
