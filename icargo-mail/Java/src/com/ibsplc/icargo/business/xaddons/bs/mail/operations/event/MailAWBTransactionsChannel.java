package com.ibsplc.icargo.business.xaddons.bs.mail.operations.event;
...
@EventChannel(value = "BS-performMailAWBTransactions", targetClass = MailSummaryDeatilsVO.class, listeners = {
