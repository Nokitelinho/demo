package com.ibsplc.icargo.business.xaddons.bs.mail.operations.event.mapper;
...
import com.ibsplc.icargo.business.xaddons.bs.mail.operations.proxy.SharedDefaultsProxy;
import com.ibsplc.icargo.business.xaddons.bs.mail.operations.vo.MailSummaryDeatilsVO;
...
@BeanConverterRegistry("bs.mail.operations.MailAWBTransactionsMapper")
public class MailAWBTransactionsMapper  implements ContextAware {
	...
	private static final String EVENT_CODE = "DLV";
	...
	public  MailSummaryDeatilsVO  performMailAWBTransactions(SaveCollectionListDeliveryFeatureVO savecollectionListdeliveryVO) throws SystemException, ProxyException {
		log.entering(MailAWBTransactionsMapper.class.getCanonicalName(),  "sendShipmentDespatchReportForDelivery");
		...
		mailSummaryVO.setEventCode(EVENT_CODE);
		log.exiting(MailAWBTransactionsMapper.class.getCanonicalName(), "sendShipmentDespatchReportForDelivery");
