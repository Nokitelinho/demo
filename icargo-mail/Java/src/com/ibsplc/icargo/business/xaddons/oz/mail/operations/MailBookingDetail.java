...
import com.ibsplc.icargo.persistence.dao.xaddons.oz.mail.operations.OZMailTrackingDefaultsDAO;
...
public class MailBookingDetail {
	...
	private static final String MODULENAME = "ozmail.operations";
	...
	private void populatePk(MailBookingDetailVO mailBookingDetailVO) throws SystemException {
		...
		if(mailBookingDetailVO.getBookingFlightNumber()!=null && mailBookingDetailVO.getBookingFlightSequenceNumber()>0)
		{
	 ...
	 */
	private static OZMailTrackingDefaultsDAO constructDAO()
			throws SystemException {
		try {
			EntityManager em = PersistenceController.getEntityManager();
			return OZMailTrackingDefaultsDAO.class.cast(em
