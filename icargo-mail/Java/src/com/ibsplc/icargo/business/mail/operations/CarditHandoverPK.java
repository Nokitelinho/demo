/*
 * CarditHandoverPK.java Created on JAN 04, 2009
 *
...
@TableKeyGenerator(name = "ID_GEN", table = "MALCDTREFKEY", key = "HNDOVR_SER_NUM")
@Embeddable 
public class CarditHandoverPK  implements Serializable{
	...
	public int hashCode() {
		return new StringBuilder().append(companyCode).append(carditKey)
				.append(handoverSerialNumber).toString().hashCode();
	}
	...
	/**
	 * @return the handoverSerialNumber
	 */
	@Key(generator = "ID_GEN", startAt = "1")
	public int getHandoverSerialNumber() {
		return handoverSerialNumber;
	}
	/**
	 * @param handoverSerialNumber the handoverSerialNumber to set
	 */
	public void setHandoverSerialNumber(int handoverSerialNumber) {
		this.handoverSerialNumber = handoverSerialNumber;
	}
	...
	public String toString() {
		...
		sbul.append("CarditHandoverPK [ ");
		sbul.append("carditKey '").append(this.carditKey);
		sbul.append("', companyCode '").append(this.companyCode);
		sbul.append("', handoverSerialNumber '").append(
				this.handoverSerialNumber);
		sbul.append("' ]");
