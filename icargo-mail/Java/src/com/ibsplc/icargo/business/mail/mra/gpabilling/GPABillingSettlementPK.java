/**
 * GPABillingSettlementPK.java Created on Mar 30, 2012
 *
 ...
 *
 */
@KeyTable(table = "MALMRAGPASTLKEY ", keyColumn = "KEYTYP", valueColumn = "MAXSEQNUM")
@TableKeyGenerator(name = "ID_GEN", table = "MALMRAGPASTLKEY ", key = "STL_SEQNUM")
@Embeddable
public class GPABillingSettlementPK implements Serializable{
	 ...
	 */
	public GPABillingSettlementPK(String companyCode,String gpaCode,
			String settlementReferenceNumber,int  settlementSequenceNumber){
	...
	public int hashCode() {
		...
		append(settlementSequenceNumber).
		toString().hashCode();
	}
	/**
	...
	public String toString() {
		...
		sbul.append("GPABillingSettlementPK [ ");
