/**
 *	Java file	: 	com.ibsplc.icargo.business.mail.operations.worker.MailFlightClosureWorker.java
 *
 *	Created by	:	A-4809
...
public class MailFlightClosureWorker extends RequestWorker{
	...
	public void execute(WorkerContext workercontext) throws SystemException {
		...
		log.entering("MailFlightClosureWorker", "execute");
		...
		despatchRequest("closeFlightForMailOperation", companyCode,time,null);
		log.exiting("MailFlightClosureWorker", "execute");
