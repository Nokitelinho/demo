/*
 * MailContractBillingDetailHistoryPK.java Created on March 30, 2007
 *
 ...
 */
@Embeddable
public class MailContractBillingDetailHistoryPK implements Serializable {
	 ...
	 * Default constructor
	 */
	public MailContractBillingDetailHistoryPK() {
	}
	 ...
	 * @param versionNumber
	 */
	public MailContractBillingDetailHistoryPK(String companyCode,
	...
	public int hashCode() {
		return new StringBuffer(companyCode).append(contractReferenceNumber)
				.append(billingMatrixCode).append(versionNumber).toString()
				.hashCode();
	}
	...
	public String toString() {
		...
		sbul.append("MailContractBillingDetailHistoryPK [ ");
