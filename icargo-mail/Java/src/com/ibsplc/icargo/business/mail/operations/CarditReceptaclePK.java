/*
 * CarditReceptaclePK.java Created on Jun 7, 2006
 *
...
public class CarditReceptaclePK implements Serializable {
	...
	public int hashCode() {
		return new StringBuilder().append(companyCode).append(carditKey)
				.append(receptacleId).toString().hashCode();
	}
    /**
     *@param other
     *@return
	...
	public String toString() {
		...
		sbul.append("CarditReceptaclePK [ ");
		sbul.append("carditKey '").append(this.carditKey);
		sbul.append("', companyCode '").append(this.companyCode);
		sbul.append("', receptacleId '").append(this.receptacleId);
		sbul.append("' ]");
