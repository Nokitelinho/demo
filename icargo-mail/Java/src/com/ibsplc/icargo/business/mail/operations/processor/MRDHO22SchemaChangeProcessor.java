 ...
 *
 */
public class MRDHO22SchemaChangeProcessor implements Processor {


	public MRDHO22SchemaChangeProcessor(Properties props){


	}

	public MRDHO22SchemaChangeProcessor(){

	}

	public List<CommunicationVO> process(List<CommunicationVO> arg0)
			throws IOException, CommunicationException {
		String schema1 = "<!DOCTYPE handover_list PUBLIC \"-//IPC//Mail Handover 2.2//EN\" \"https://public.ipc.be/mrd/desc/dtd/ho22.dtd\"><handover_list>";
		String schema2 = "<handover_list xmlns=\"https://public.ipc.be/mtd/desc/dtd//ho22.dtd\">";
