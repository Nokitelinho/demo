/*
 * MailContractHistoryVO.java created on Mar 30, 2007
 ...
 * 
 */
public class MailContractHistoryVO extends AbstractVO {
	/**
	 * Company Code
	 */
	...
	/**
	 * Mail contract history details
	 */
	private Collection<MailContractDetailsHistoryVO> contractDetailsHistoryVos;

	/**
	 * Mail contract billing matrix history details
	 */
	private Collection<MailContractBillingDetailsHistoryVO> contractBillingDetailsHistoryVos;
	...
	/**
	 * @return Returns the contractBillingDetailsHistoryVos.
	 */
	public Collection<MailContractBillingDetailsHistoryVO> getContractBillingDetailsHistoryVos() {
		return contractBillingDetailsHistoryVos;
	}

	/**
	 * @param contractBillingDetailsHistoryVos
	 *            The contractBillingDetailsHistoryVos to set.
	 */
	public void setContractBillingDetailsHistoryVos(
			Collection<MailContractBillingDetailsHistoryVO> contractBillingDetailsHistoryVos) {
		this.contractBillingDetailsHistoryVos = contractBillingDetailsHistoryVos;
	}
	...
	/**
	 * @return Returns the contractDetailsHistoryVos.
	 */
	public Collection<MailContractDetailsHistoryVO> getContractDetailsHistoryVos() {
		return contractDetailsHistoryVos;
	}

	/**
	 * @param contractDetailsHistoryVos
	 *            The contractDetailsHistoryVos to set.
	 */
	public void setContractDetailsHistoryVos(
			Collection<MailContractDetailsHistoryVO> contractDetailsHistoryVos) {
		this.contractDetailsHistoryVos = contractDetailsHistoryVos;
	}
