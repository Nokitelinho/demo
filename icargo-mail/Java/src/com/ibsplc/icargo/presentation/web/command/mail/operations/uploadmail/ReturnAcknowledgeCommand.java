/*
 * ReturnAcknowledgeCommand.java Created on Oct 08, 2005
 *
 ...
 *
 */
public class ReturnAcknowledgeCommand extends BaseCommand {
	...
	public void execute(InvocationContext invocationContext)
		...
		log.entering("ReturnAcknowledgeCommand","execute");
		...
		String[] primKeyArr = uploadMailForm.getSelectReturn();
		...
		log.log(Log.INFO, "mailbagReturnVOs....for ack.\n", mailbagReturnVOs);
		uploadMailSession.setScannedDetailsVO(scannedDetailsVO);
		
		invocationContext.target = TARGET;
		log.exiting("ReturnAcknowledgeCommand","execute");
