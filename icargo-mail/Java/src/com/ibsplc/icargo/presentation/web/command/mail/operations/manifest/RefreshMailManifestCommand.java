/*
 * RefreshMailManifestCommand.java Created on Jul 1 2016
 *
 ...
 *
 */
public class RefreshMailManifestCommand extends BaseCommand {
   ...
   private static final String CONST_FLIGHT = "FLIGHT";
    ...
    public void execute(InvocationContext invocationContext)
    	...
    	log.entering("RefreshMailManifestCommand","execute");
    	...
    	log.exiting("RefreshMailManifestCommand","execute");
