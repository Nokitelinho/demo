/*
 * PrintDetailsCommand.java Created on Jan 8, 2007
 *
 ...
 *
 */
public class PrintDetailsCommand extends AbstractPrintCommand{
	...
	private static final String REPORT_ID = "RPTMRA031";
	...
	private static final String ACTION = "findFlownMailExceptionsforprintDetails";
	...
	public void execute(InvocationContext invocationContext)throws CommandInvocationException {
    	...
    	log.log(Log.FINE, "*******filter to server ", flownMailFilterVO);
	...
	public FlownMailFilterVO getFilterDetails(AssignExceptionsForm assignExceptionsForm,
		...
		log
				.log(Log.FINE, "**********", assignExceptionsForm.getExceptionCode());
		...
		log.exiting(CLASS_NAME, "getFilterDetails");
