...
package com.ibsplc.icargo.presentation.web.command.mail.mra.gpareporting.ux.despatchlov;
	 ...
	 *
	 */
	public class ScreenloadDespatchLovCommand extends BaseCommand{
		...
		private static final String CLASS_NAME = "ScreenloadDespatchLovCommand";
		...
		throws CommandInvocationException {
			...
			if(dsnLovForm.getCode()!=null)
			{
			dsnLovForm.setLovDescriptionTxtFieldName(dsnLovForm.getCode());
			}
			else{
		 ...
		 * @return
		 */
		private Collection<ErrorVO> validateForm(DespatchLOVForm dsnLovForm) {
			Collection<ErrorVO> errorVOs=new ArrayList<ErrorVO>();
		 ...
		 * @return
		 */
		private CCAdetailsVO populateccAdetailsVO(DespatchLOVForm dsnLovForm) {
