	...
	*/
	public void execute(InvocationContext invocationContext) throws CommandInvocationException {
		...
		//Added by A-6991 for ICRD-196641
			consignmentFilterVO.setSubType(consignmentForm.getSubType());
			consignmentFilterVO.setConType(consignmentForm.getType());//Added for ICRD_212235 starts
...
/*			if(consignmentForm.getReportFlag()!=null && "Y".equals(consignmentForm.getReportFlag()))
			...
			}else if(MailConstantsVO.CONSIGNMENT_TYPE_CN37.equals(consignmentForm.getType())){
				getReportSpec().setReportId(REPORT_ID_CN37);          
			}else if(MailConstantsVO.CONSIGNMENT_TYPE_CN38.equals(consignmentForm.getType())){
				getReportSpec().setReportId(REPORT_ID_CN38);
			}else if(MailConstantsVO.CONSIGNMENT_TYPE_CN46.equals(consignmentForm.getType())){   
				getReportSpec().setReportId(REPORT_ID_CN46);
			}else if(MailConstantsVO.CONSIGNMENT_TYPE_CN47.equals(consignmentForm.getType())){     
				getReportSpec().setReportId(REPORT_ID_CN47);  
			}
			//Added for ICRD_212235 starts
			else if(MailConstantsVO.CONSIGNMENT_TYPE_AV7.equals(consignmentForm.getType())){     
