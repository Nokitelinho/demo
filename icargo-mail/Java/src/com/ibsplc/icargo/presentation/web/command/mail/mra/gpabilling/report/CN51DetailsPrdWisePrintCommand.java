/*
 * CN51DetailsPrdWisePrintCommand.java Created on Mar 02,2007
 *
 ...
 *
 */
public class CN51DetailsPrdWisePrintCommand extends AbstractPrintCommand {
	...
	private static final String REPORT_ID = "RPTMRA035";
	private static final String RESOURCE_BUNDLE_KEY = "gpabillingreports";

	private static final String ACTION = "printcn51detailsperiodwise";
	...
	throws CommandInvocationException {
		...
		String fromDate=form.getFromDatePeriod51();
		String toDate=form.getToDatePeriod51();
		String gpaCode=form.getGpaCodePeriod51();
		String gpaName=form.getGpaNamePeriod51();
