/*
 * CloseFlightCommand.java Created on Jun 30 2016
 *
	   ...
	   private static final String CLOSE_FAILURE = "failure";
	    ...
	    public void execute(InvocationContext invocationContext)
			...
			if (sysParameterMap != null && OperationalFlightVO.FLAG_YES.equals(sysParameterMap
				...
				if(!canCloseFlight){
					invocationContext.addError(new ErrorVO("mailtracking.defaults.err.routingunavailable"));
    	...
    	//	invocationContext.addError(new ErrorVO("mailtracking.defaults.mailarrival.flightclosed",obj));
