...
public class PostalAdministrationUxLovForm extends ScreenModel {

	private static final String SCREEN_ID = "mailtracking.defaults.masters.ux.postaladminlov";
	private static final String PRODUCT_NAME = "mail";
	private static final String SUBPRODUCT_NAME = "operations";
	private static final String BUNDLE = "postalAdminUxLovResources";
	...
	private Page paLovPage;
	
	private int index;  
	
	private String defaultPageSize="10";
	private String screenMode;
	private String fromLOV;
	/**
	 * @return screenId
	 */
	 ...
	 * @return the fromLOV
	 */
	public String getFromLOV() {
		return fromLOV;
	}
	/**
	 * @param fromLOV the fromLOV to set
	 */
	public void setFromLOV(String fromLOV) {
		this.fromLOV = fromLOV;
	}
	...
	/**
	 * @return Returns the paLovPage.
	 */
	public Page getPaLovPage() {
		return paLovPage;
	}

	/**
	 * @param paLovPage The paLovPage to set.
	 */
	public void setPaLovPage(Page paLovPage) {
		this.paLovPage = paLovPage;
	}
