/*
 * CN66ReportPrintCommand.java Created on Feb 27,2007
 *
...
public class CN66ReportPrintCommand extends AbstractPrintCommand {
	...
	private static final String REPORT_ID = "RPTMRA001";
	private static final String RESOURCE_BUNDLE_KEY = "listcn51cn66";
	
	private static final String ACTION = "generateCN66Report";
...
//		}
		...
		//reportSpec.setData(session.getCN66VOs());//Modified for ICRD-105225
