/*
 * CancelCommand.java Created on Apr 04, 2007
 *
...
public class CancelCommand extends BaseCommand {
	...
	private static final String SCREEN_CANCEL="cancel";
	/**
	...
	form.setAgreementStatus(CANCEL_STATUS);
	form.setScreenStatus(SCREEN_CANCEL);
	if(session.getMailContractVO()!=null){
		session.getMailContractVO().setAgreementStatus(CANCEL_STATUS);
