...
public class ListDSNDetailCommand  extends BaseCommand {
	...
	private static final String KEY_IMPORT_EXP = "mailtracking.mra.defaults.rateauditdetails.importwithexception";
	...
	public void execute(InvocationContext invocationContext) throws CommandInvocationException {
		...
		String dsnNumber = rateAuditDetailsForm.getDsnNumber();
		String dsnDate = rateAuditDetailsForm.getDsnDate();
		String fromScreen = "RateAuditDetails";
		int pageNumber = 1; 
		...
		if(despatchLovVOs != null && despatchLovVOs.size() > 0) {
			...
			if(despatchLovVOs.size() == 1) {
				...
				if(dsnPopUpVO.getBillingDetailsCount() == 0) {
					...
					rateAuditDetailsForm.setShowDsnPopUp(FLAG_FALSE);
				...
				rateAuditDetailsForm.setShowDsnPopUp(FLAG_TRUE);
