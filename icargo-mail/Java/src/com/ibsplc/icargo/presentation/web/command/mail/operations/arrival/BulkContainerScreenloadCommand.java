 ...
 *
 */
public class BulkContainerScreenloadCommand extends BaseCommand {
    ...
    * TARGET
    */
   private static final String TARGET = "bulk_success";
   ...
   private static final String SCREEN_ID = "mailtracking.defaults.mailarrival";	
    ...
    public void execute(InvocationContext invocationContext)
    	...
    	log.entering("BulkContainerScreenLoadCommand","execute");
