/*
 * InactivateFactorCommand.java Created on Dec 02, 2006
 *
 ...
 */
public class InactivateFactorCommand extends BaseCommand {
	/**
	...
	private static final String INACTIVATE_SUCCESS = "inactivate_success";
	...
	public void execute(InvocationContext invocationContext)
		...
		maintainProrateFactorsForm.setDateStatusFlag("D");
		prorateFactorVO.setProrationFactorStatus("I");
		prorateFactorVO
				.setOperationFlag(ProrationFactorVO.OPERATION_FLAG_UPDATE);
		prorateFactorVO.setToDate(null);
		prorateFactorVO.setFromDate(null);
	...
	private void updateDetails(
		...
		if (maintainProrateFactorsForm.getDestinationCityCode() != null
			...
			String[] operationFlags = maintainProrateFactorsForm
					.getOperationFlag();
			/*
			 * ArrayList<ProrationFactorVO> vos = new ArrayList<ProrationFactorVO>();
			 * List<ProrateFactorVO> privList = (List<ProrationFactorVO>) vos;
			 */
