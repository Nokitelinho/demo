/*
 * TrashScreenloadCommand.java Created on Jul 1 2016
 *
 ...
 *
 */
public class TrashScreenloadCommand extends BaseCommand {
   ...
   private static final String SCREEN_ID = 
    ...
    public void execute(InvocationContext invocationContext)
    	...
    	log.entering("TrashScreenloadCommand","execute");
		...
		try {
			...
			invvo=mailTrackingDefaultsDelegate.findInventoryList(logonAttributes.getCompanyCode(),
					logonAttributes.getAirportCode(),Integer.parseInt(inventoryListForm.getCarrierID()));
		...
		log.log(Log.FINE, "inventoryvo--------->>", invvo);
		inventoryListForm.setStatusFlag("");
		//inventoryListSession.setInventorySummaryVO(summaryvo);
		
		inventoryListSession.setInventoryListVO(invvo);
    	invocationContext.target = TARGET_SUCCESS;
       	
    	log.exiting("TrashScreenloadCommand","execute");
