/*
 * GPAInvoicesPrintCommand.java Created on Jan 17,2013
 *
 ...
 *
 */
public class GPAInvoicesPrintCommand extends AbstractPrintCommand {
	...
	private static final String REPORT_ID = "RPRMRA002";
	private static final String RESOURCE_BUNDLE_KEY = "listcn51cn66";
	
	private static final String ACTION = "generateGPAInvoiceReportSQ";
	...
	throws CommandInvocationException {
		...
		log.entering("MAILTRACKING_GPAILLING","generateGPAInvoiceReportSQ");
