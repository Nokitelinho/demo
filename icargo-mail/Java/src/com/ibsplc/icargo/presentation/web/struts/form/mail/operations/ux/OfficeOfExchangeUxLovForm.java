...
/**
 * 
 *	Java file	: 	com.ibsplc.icargo.presentation.web.struts.form.mail.operations.ux.OfficeOfExchangeUxLovForm.java
 *	Version		:	Name	:	Date			:	Updation
 * ---------------------------------------------------
 *		0.1		:	A-8164	:	05-Jul-2018	:	Draft
 */
public class OfficeOfExchangeUxLovForm extends ScreenModel {

	private static final String SCREEN_ID = "mailtracking.defaults.masters.ux.oelov";
	private static final String PRODUCT_NAME = "mail";
	private static final String SUBPRODUCT_NAME = "operations";
	private static final String BUNDLE = "oeUxLovResources";
	...
	/**
	 * @return Returns the oeLovPage.
	 */
	public Page getOeLovPage() {
		return oeLovPage;
	}

	/**
	 * @param oeLovPage The oeLovPage to set.
	 */
	public void setOeLovPage(Page oeLovPage) {
		this.oeLovPage = oeLovPage;
	}
