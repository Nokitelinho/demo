...
public class ClearCommand extends BaseCommand {
    ...
    public void execute(InvocationContext invocationContext)
    	...
    	listUPURateCardForm.setRateCardID(BLANK);
    	listUPURateCardForm.setRateCardStatus(BLANK);
    	listUPURateCardForm.setStartDate(BLANK);
    	listUPURateCardForm.setEndDate(BLANK);
