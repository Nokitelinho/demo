/*
 * SendAndFinalizeInvoiceCommand.java Created on Jan 23, 2009
 *
 ...
 *
 */
public class SendAndFinalizeInvoiceCommand extends BaseCommand {
    ...
    public void execute(InvocationContext invocationContext)
		...
		log
				.log(Log.FINE, "<-------------cN51SummaryVO------->>",
						cN51SummaryVO);
		if(cN51SummaryVO!=null){
    	log.log(Log.INFO, "\n\n\n\n<-------EINVOICE MSG IS---->", form.getTxtInvoiceMsg());
		try {		
			Collection<CN51SummaryVO> cn51SummaryVOS=new ArrayList<CN51SummaryVO>();
			cn51SummaryVOS.add(cN51SummaryVO);
			mailTrackingMRADelegate.finalizeandSendEInvoice(cn51SummaryVOS,form.getTxtInvoiceMsg());
