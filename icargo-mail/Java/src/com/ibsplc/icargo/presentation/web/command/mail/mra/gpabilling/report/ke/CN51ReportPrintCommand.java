/*
 * CN51ReportPrintCommand.java Created on Jan 09, 2018
 *
 ...
 */
package com.ibsplc.icargo.presentation.web.command.mail.mra.gpabilling.report.ke;
...
public class CN51ReportPrintCommand extends AbstractPrintCommand {
	...
	private static final String REPORT_ID = "RPTMRA045";
	private static final String RESOURCE_BUNDLE_KEY = "listcn51cn66";

	private static final String ACTION = "generateCN51ReportKE";
	...
	/**
	 * This method is used to get the one time details for mail category
	 * 
	 * @return
	 */
	public  Collection<OneTimeVO> getOneTimeDetails() {
		...
		log.exiting("PrintCommand", error.toString());
		if(oneTimes != null ){
