/*
 * BlgSmyPeriodWisePrintCommand.java Created on Mar 14, 2007
 *
 ...
 *
 */
public class BlgSmyPeriodWisePrintCommand extends AbstractPrintCommand {
	...
	private static final String REPORT_ID = "RPTMRA033";
	private static final String RESOURCE_BUNDLE_KEY = "gpabillingreports";
	
	private static final String ACTION = "printbillingsmyperiodwise";
	...
	throws CommandInvocationException {
		...
		String fromDate=form.getFromDatePeriodBillSmy();
		String toDate=form.getToDatePeriodBillSmy();
		String gpaCode=form.getGpaCodePeriodBillSmy();
		String gpaName=form.getGpaNamePeriodBillSmy();
		...
		if(country!=null && country.trim().length()>0){
			filterVO.setCountry(country.trim().toUpperCase());
		}
