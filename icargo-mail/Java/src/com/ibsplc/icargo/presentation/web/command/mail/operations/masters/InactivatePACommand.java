/*
 * InactivatePACommand.java Created on June 17, 2008
 *
 ...
 *
 */
public class InactivatePACommand  extends BaseCommand{
	...
	private static final String REMARKS_EMPTY="mailtracking.defaults.pamaster.msg.err.remarksempty";
	private static final String INACTIVATE_SUCCESS = 
		"mailtracking.defaults.pamaster.msg.info.inactivatesuccess";
	...
	public void execute(InvocationContext invocationContext)
		...
		if(paSession.getPaVO() != null){
			...
			if(("").equals(paMasterForm.getRemarks())) {
		    	log.log(Log.FINE, "\n\n REMARKS_EMPTY =============> \n\n");
		    	ErrorVO error = new ErrorVO(REMARKS_EMPTY);
		    	errors.add(error);
	    	}
			...
			paVO.setStatus(STATUS_INACTIVE);			
...
log.log(Log.FINE, "\n\n paVO----------> ", paVO);
		...
		ErrorVO error = new ErrorVO(INACTIVATE_SUCCESS);
		errors.add(error);
		invocationContext.addAllError(errors);
    	...
    	paMasterForm.setStatusActiveOrInactive(STATUS_INACTIVE);
