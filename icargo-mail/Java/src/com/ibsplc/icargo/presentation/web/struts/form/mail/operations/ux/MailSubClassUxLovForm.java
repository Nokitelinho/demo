...
/**
 * 
 *	Java file	: 	com.ibsplc.icargo.presentation.web.struts.form.mail.operations.ux.MailSubClassUxLovForm.java
 *	Version		:	Name	:	Date			:	Updation
 * ---------------------------------------------------
 *		0.1		:	A-8164	:	05-Jul-2018	:	Draft
 */
public class MailSubClassUxLovForm extends ScreenModel {
	
	private static final String SCREEN_ID = "mailtracking.defaults.masters.ux.mailsubclasslov";
	private static final String PRODUCT_NAME = "mail";
	private static final String SUBPRODUCT_NAME = "operations";
	private static final String BUNDLE = "mailsubclassUxLovResources";
	...
	/**
	 * @return Returns the subClassLovPage.
	 */
	public Page getSubClassLovPage() {
		return subClassLovPage;
	}

	/**
	 * @param subClassLovPage The subClassLovPage to set.
	 */
	public void setSubClassLovPage(Page subClassLovPage) {
		this.subClassLovPage = subClassLovPage;
	}
