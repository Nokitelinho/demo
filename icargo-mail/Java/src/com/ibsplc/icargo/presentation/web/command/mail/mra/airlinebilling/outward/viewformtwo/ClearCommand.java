/*
 * ClearCommand.java Created on July 24,2008
 *
...
public class ClearCommand extends BaseCommand {
	...
	public void execute(InvocationContext invocationContext)
		...
		ViewMailFormTwoForm viewMailFormTwoForm =
		...
		viewMailFormTwoForm.setScreenStatusFlag(
  				ComponentAttributeConstants.SCREEN_STATUS_SCREENLOAD);
		viewMailFormTwoForm.setClearancePeriod(EMPTY_STRING);
		viewFormTwoSession.setAirlineForBillingVOs(null);
