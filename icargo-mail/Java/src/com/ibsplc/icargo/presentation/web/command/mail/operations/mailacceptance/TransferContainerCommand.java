...
/**
 * 
 *	Java file	: 	com.ibsplc.icargo.presentation.web.command.mail.operations.mailacceptance.TransferContainerCommand.java
...
public class TransferContainerCommand extends BaseCommand {
	...
	private static final String SCREEN_STATUS="showTransferContainerScreen";	
	 ...
	 public void execute(InvocationContext invocationContext)
			...
			log.entering("TransferContainerCommand","entry");
			...
			MailAcceptanceForm mailAcceptanceForm =
                ...
                String[] primaryKey=mailAcceptanceForm.getSelectedContainer().split(",");   
                ...
                mailAcceptanceForm.setTransferContainerFlag(SCREEN_STATUS);
			
				invocationContext.target = TARGET_SUCCESS;
			log.exiting("TransferContainerCommand","exit");
	}
