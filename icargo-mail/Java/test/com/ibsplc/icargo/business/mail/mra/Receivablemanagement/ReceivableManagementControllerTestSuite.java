/**
 *	Java file	: 	com.ibsplc.icargo.business.mail.mra.Receivablemanagement.ReceivableManagementControllerTestSuite.java
 *
 *	Created by	:	A-10647
...
@RunWith(Suite.class)
@SuiteClasses({ 
	ReceivableManagementControllerTest.class
})
public class ReceivableManagementControllerTestSuite {
