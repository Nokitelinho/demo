/**
 *	Java file	: 	com.ibsplc.icargo.business.xaddons.lh.mail.operations.ContainerHBADetailsTest.java
 *
...
@RunWith(Suite.class)
@SuiteClasses({ 
	ContainerHBADetailsTest.class
})
public class ContainerHBADetailsTestSuite {
