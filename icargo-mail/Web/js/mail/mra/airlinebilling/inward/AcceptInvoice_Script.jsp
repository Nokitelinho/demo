...
function ok(){
	submitForm(targetFormName,'mailtracking.mra.airlinebilling.inward.remarksok.do');
...
if(status=='ok'){
				...
				window.opener.targetFormName.action="mailtracking.mra.airlinebilling.inward.invoiceexceptionsaccept.do";
