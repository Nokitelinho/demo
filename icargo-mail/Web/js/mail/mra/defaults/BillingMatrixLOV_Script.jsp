...
function screenSpecificEventRegister(){
	...
	with(frm){
		...
		//evtHandler.addEvents("btnClear","submitForm(this.form,'clearBillingMatrixLOV.do')",EVT_CLICK);
		evtHandler.addEvents("btnClear","clearLOVForm()",EVT_CLICK);//Added as part of ICRD-145955
