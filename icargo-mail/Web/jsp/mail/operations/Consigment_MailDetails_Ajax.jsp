...
<ihtml:form action="/mailtracking.defaults.consignment.addmultiplemailbags.do">
...
<logic:present name="conDocVOSession" property="mailInConsignmentVOs">
	...
	<div class="ic-row">
						<div class="tableContainer"  style="height:400px;"> 
							...
							<jsp:include page="Consigment_MailDetails_Label.jsp" /> 
								<tbody id="mailTableBody">
											<logic:present name="conDocVOSession" property="mailInConsignmentVOs">
												...
												<common:rowColorTag index="index">
													...
													<% String mailId="",ooeValue="",doeValue="",mailSubclassValue="";
									...
									<tr>
															...
															<td>
																<logic:present name="mailInConsignmentVO" property="mailId">
																	...
																	<%mailId=(String)mailbagId;%>
																</logic:present>
															<ihtml:text property="mailbagId" value="<%=mailId%>" componentID="CMP_MAILTRACKING_DEFAULTS_CONSIGMENT_MAILBAGID" maxlength="29"  readonly="<%=toDisable%>" indexId="index" style="width:190px"/>
															...
															<ihtml:text property="originOE" value="<%=(String)ooeValue%>" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_OOE" maxlength="6"  readonly="<%=toDisable%>" indexId="index"/>
																	<img name="OOELov" id="OOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov.png" width="16" height="16" disabled="<%=toDisable%>">
															...
															<td>
																...
																<ihtml:text property="destinationOE" value="<%=(String)doeValue%>" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_DOE" maxlength="6"  readonly="<%=toDisable%>" indexId="index"/>
																<img name="DOELov" id="DOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov.png" width="16" height="16" disabled="<%=toDisable%>">
															...
															<td>
																<% String subclassValue = ""; %>
																	<logic:present name="mailInConsignmentVO" property="mailSubclass">
																		...
																		if(arrays==-1){
																		mailSubclassValue=subclassValue;
																		}
																		%>																			
																	</logic:present>
																<ihtml:text property="subClass" value="<%=(String)mailSubclassValue%>" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_SC" maxlength="2"  readonly="<%=toDisableWt%>" indexId="index"/>
																<img name="SCLov" id="SCLov<%=index%>" src="<%=request.getContextPath()%>/images/lov.png" width="16" height="16" disabled="<%=toDisableWt%>">
															...
															<td>
																<logic:notPresent name="mailInConsignmentVO" property="dsn">
																	<ihtml:text property="dsn" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_DSN" value="" maxlength="4"  readonly="<%=toDisable%>" indexId="index" style = "text-align:right"/>
																</logic:notPresent>
																<logic:present name="mailInConsignmentVO" property="dsn">
																	<bean:define id="dsn" name="mailInConsignmentVO" property="dsn" toScope="page"/>
																	<ihtml:text property="dsn" value="<%=(String)dsn%>" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_DSN" maxlength="4"  readonly="<%=toDisable%>"  indexId="index" style = "text-align:right"/>
																</logic:present>
															</td>
															<td>
																<logic:notPresent name="mailInConsignmentVO" property="receptacleSerialNumber">
																	<ihtml:text property="rsn" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_RSN" value="" maxlength="3"  readonly="<%=toDisable%>"  indexId="index" style = "text-align:right"/>
																</logic:notPresent>
																<logic:present name="mailInConsignmentVO" property="receptacleSerialNumber">
																	<bean:define id="rsn" name="mailInConsignmentVO" property="receptacleSerialNumber" toScope="page"/>
																	<ihtml:text property="rsn" value="<%=(String)rsn%>" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_RSN" maxlength="3"  readonly="<%=toDisable%>" indexId="index" style = "text-align:right"/>
																</logic:present>
															</td>
															<td>
																<logic:notPresent name="mailInConsignmentVO" property="statedBags">
																	<ihtml:text property="numBags" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_NUMBAG" value="" maxlength="5"  readonly="<%=toDisableWt%>"  style = "text-align:right"/>
																</logic:notPresent>
															...
															<td>
													            <logic:notPresent name="mailInConsignmentVO" property="statedWeight">
																	<ibusiness:unitdef id="weight" unitTxtName="weight" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_WT" label=""  unitReq = "false" dataName="weight"
																			 unitValueStyle="iCargoEditableTextFieldRowColor1" title="Stated Weight"
																			unitValue="0.0" style="background :'<%=color%>';text-align:right;"
																			indexId="index" styleId="weight"  unitTypePassed="MWT" />
																	
															    </logic:notPresent>
															    <logic:present name="mailInConsignmentVO" property="statedWeight">
																	<bean:define id="mailWeight" name="mailInConsignmentVO" property="statedWeight" toScope="page" type="com.ibsplc.icargo.framework.util.unit.Measure"/><!--A-7371-->
																	...
																	<% request.setAttribute("weight",mailWeight); %>
																        ...
																        <ibusiness:unitdef id="weight" unitTxtName="weight" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_WT" label=""  unitReq = "false" dataName="weight"
																			...
																			indexId="index" styleId="weight" unitTypePassed="MWT" readonly="<%=toDisable%>" />
														...
														<td>
															...
															<td>
													            <logic:notPresent name="mailInConsignmentVO" property="uldNumber">
																	<ibusiness:uld id="uldNum" uldProperty="uldNum" style="text-transform:uppercase;" indexId="rowCount" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_ULDNUM" maxlength="12" uldValue=""/>
															    </logic:notPresent>
															    <logic:present name="mailInConsignmentVO" property="uldNumber">
																	...
																	<ibusiness:uld id="uldNum" uldProperty="uldNum" style="text-transform:uppercase;" indexId="rowCount" componentID="TXT_MAILTRACKING_DEFAULTS_CONSIGNMENT_ULDNUM" maxlength="12" uldValue="<%=(String)uldNum%>"/>
												    			</logic:present>
															</td>
								</tr>
													</logic:notEqual>
