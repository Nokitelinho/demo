...
<bean:define id="form" name="ForceMajeureRequestForm"
	...
	<div id="popSort" class="show-sorting" style="display:none">
        <div class="sort-by">
<ul>
<li>			
			...
			<li>
					<logic:present name="form" property="sortOrder">
						<logic:equal name="form" property="sortingField" value="weight">
							...
							<logic:equal name="form" property="sortOrder" value="DESC">
								<a href="#"  onClick="sortData('weight','DESC');"><b>Wt.(kg)</b> <span class="float-right"><i class="icon ico-updown-dark ico-updown-dark-down"></i></a></span> 
								<% form.setSortingField("weight");%>
								<% form.setSortOrder("DESC");%>
							</logic:equal>
						</logic:equal>
			...
			<li>
					<logic:present name="form" property="sortOrder">
						<logic:equal name="form" property="sortingField" value="originAirport">
							<logic:equal name="form" property="sortOrder" value="ASC">
								<a href="#"   onClick="sortData('originAirport','ASC');"><b>Org </b><span class="float-right"><i class="icon ico-updown-dark ico-updown-dark-up"></i></a></span> 
			...
			<li>
					<logic:present name="form" property="sortOrder">
						<logic:equal name="form" property="sortingField" value="consignmentDocNumber">
							<logic:equal name="form" property="sortOrder" value="ASC">
								<a href="#"  onClick="sortData('consignmentDocNumber','ASC');"><b>Consignment No.</b><span class="float-right"><i class="icon ico-updown-dark ico-updown-dark-up"></i></a></span> 
