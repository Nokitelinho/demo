...
<business:sessionBean id="pousSession" moduleName="mail.operations" screenID="mailtracking.defaults.mailacceptance" method="get" attribute="pous" />
	...
	<logic:present name="desptachDetailsVO" property="displayLabel"> 
		<logic:equal name="desptachDetailsVO" property="displayLabel" value="Y">
			...
			<td class="iCargoTableDataTd">
			<common:write name="desptachDetailsVO" property="statedWeight" unitFormatting="true" />
		...
		<logic:equal name="desptachDetailsVO" property="displayLabel" value="N">
			...
			<td  class="iCargoTableDataTd">
				...
				<logic:present name="desptachDetailsVO" property="paCode">
			    	...
			    	<%if(toDisable){%>
					<img name="despatchPALov" id="despatchPALov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" disabled>
			    	<%}else{%>
					<img name="despatchPALov" id="despatchPALov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16">
				 <%}%>
			</td>
			<td  class="iCargoTableDataTd">
				...
				<%if(toDisable){%>
				<div class= "lovImgTbl">
					<img name="despatchOOELov" id="despatchOOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" disabled>
					</div>
				<%}else{%>
				<div class= "lovImgTbl">
					<img name="despatchOOELov" id="despatchOOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16">
					</div>
				<%}%>
			</td>
			<td class="iCargoTableDataTd">
			    	...
			    	<%if(toDisable){%>
					<div class= "lovImgTbl">
					<img name="despatchDOELov" id="despatchDOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" disabled>
					</div>
			    	<%}else{%>
					<div class= "lovImgTbl">
					<img name="despatchDOELov" id="despatchDOELov<%=index%>" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" >
					</div>
			    	<%}%>
			</td>
			<td class="iCargoTableDataTd">
			...
			<td class="iCargoTableDataTd">
				<logic:notPresent name="desptachDetailsVO" property="statedWeight">				
						<bean:define id="statedWeight" name="desptachDetailsVO" property="statedWeight" type="com.ibsplc.icargo.framework.util.unit.Measure"/><!-- A-7371-->
				...
				<logic:present name="desptachDetailsVO" property="statedWeight">
					<bean:define id="statedWeight" name="desptachDetailsVO" property="statedWeight" toScope="page" type="com.ibsplc.icargo.framework.util.unit.Measure"/>		
						<% request.setAttribute("sampleStdWt",statedWeight); %>
						<ibusiness:unitdef id="statedWt" unitTxtName="statedWt" label="" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_STDWGT"  unitReq = "false" dataName="sampleStdWt"
							unitValueStyle="iCargoEditableTextFieldRowColor1" title="Stated Weight"
		  ...
		  <logic:present name="desptachDetailsVO" property="acceptedBags">
			...
			<bean:define id="acceptedWeight" name="desptachDetailsVO" property="acceptedWeight" type="com.ibsplc.icargo.framework.util.unit.Measure"/><!-- A-7371-->
		  ...
		  <logic:present name="desptachDetailsVO" property="acceptedWeight">
			<bean:define id="acceptedWeight" name="desptachDetailsVO" property="acceptedWeight" toScope="page" type="com.ibsplc.icargo.framework.util.unit.Measure"/>
				<% request.setAttribute("sampleStdWt",acceptedWeight); %>
				<ibusiness:unitdef id="accWt" unitTxtName="accWt" label="" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_ACCWGT"  unitReq = "false" dataName="sampleStdWt"
					 unitValueStyle="iCargoEditableTextFieldRowColor1" title="Accepted Weight"
                  ...
                  <td class="iCargoTableDataTd">
                    <logic:notPresent name="desptachDetailsVO" property="statedVolume">
							...
							<logic:present name="desptachDetailsVO" property="statedVolume">
								<bean:define id="sampleStdVolVo" name="desptachDetailsVO" property="statedVolume" type="com.ibsplc.icargo.framework.util.unit.Measure"/> 
								<% request.setAttribute("sampleStdVol",sampleStdVolVo); %>
								<ibusiness:unitdef id="stdVolume" unitTxtName="stdVolume" label="" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_STDVOLUME"  unitReq = "false" dataName="sampleStdVol"
		  			...
		  			<logic:present name="desptachDetailsVO" property="statedVolume">
					<bean:define id="statedVolume" name="desptachDetailsVO" property="statedVolume" toScope="page" type="com.ibsplc.icargo.framework.util.unit.Measure"/>
              ...
              <td class="iCargoTableDataTd">
				<logic:notPresent name="desptachDetailsVO" property="acceptedVolume">
					<logic:present name="KEY_VOLUMEROUNDINGVO">
						...
						<% request.setAttribute("sampleStdVol",sampleStdVolVo); %>
						<ibusiness:unitdef id="accVolume" unitTxtName="accVolume" label="" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_ACCVOL"  unitReq = "false" dataName="sampleStdVol"
							 unitValueStyle="iCargoEditableTextFieldRowColor1" title="Accepted Volume"
							unitValue="0.0" 
		...
		<tr template="true" id="despatchTemplateRow" style="display:none">
		  ...
		  <td class="iCargoTableDataTd"><div  > 
		  ...
		  <td >
		    ...
		    <div class= "lovImgTbl"> <img name="despatchPALov" id="despatchPALov" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" >
			</div>
		  </td>
		  
		  <td >
		    <ihtml:text property="despatchOOE" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_DSNORIGIN" value="" maxlength="6" />
		    <div class= "lovImgTbl"> <img name="despatchOOELov" id="despatchOOELov" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" >
			</div>
		  </td>
		  
		  <td >
		    <ihtml:text property="despatchDOE" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_DSNDESTN" value="" maxlength="6" />
		    <div class= "lovImgTbl"> <img name="despatchDOELov" id="despatchDOELov" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" >
			</div>
		  </td>
		  ...
		  <td >
		     ...
		     <div class= "lovImgTbl">  <img name="despatchSCLov" id="despatchSCLov" src="<%=request.getContextPath()%>/images/lov_sm.png" width="16" height="16" >
			 </div>
		   </td>
		  ...
		  <td>
			<ihtml:text property="statedNoBags" indexId="index" styleId="statedNoBags" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_STDNUMBAG" value="" style="width:50px;text-align:right" maxlength="4"/>
		  </td>
		  <td>
		...
		<logic:present name="desptachDetailsVO" property="statedWeight">
			...
			<%--
				<ihtml:text property="statedWt" indexId="index" styleId="statedWt" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_STDWGT" value="" style="width:50px;text-align:right" maxlength="5"/>
				
			--%>	
		  </td>
		  <td>
			<ihtml:text property="accNoBags" indexId="index" styleId="accNoBags" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_NUMBAGS" value=""  style="width:40px;text-align:right" maxlength="4"/>
		  </td>
		  <td>
		  ...
		  <%--
		  	<ihtml:text property="accWt" indexId="index" styleId="accWt" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_ACCWGT" value=""  style="width:50px;text-align:right" maxlength="5"/>
		  
		  --%>
		  </td>
		  <td>	  
		<logic:present name="desptachDetailsVO" property="statedVolume"><!-- A-7371-->
			<bean:define id="sampleStdVolVo" name="desptachDetailsVO" property="statedVolume" type="com.ibsplc.icargo.framework.util.unit.Measure"/> 
				<% request.setAttribute("sampleStdVol",sampleStdVolVo); %>
				<ibusiness:unitdef id="stdVolume" unitTxtName="stdVolume" label="" componentID="TXT_MAILTRACKING_DEFAULTS_ACCEPTMAIL_STDVOLUME"  unitReq = "false" dataName="sampleStdVol"
					 unitValueStyle="iCargoEditableTextFieldRowColor1" title="Stated Volume"
