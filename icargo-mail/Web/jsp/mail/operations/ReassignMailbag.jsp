...
<head> 
	...
	<title><common:message bundle="reassignMailbagResources" key="mailtracking.defaults.reassignmailbag.lbl.title" /></title>
   <meta name="decorator" content="popuppanelrestyledui">
	<common:include type="script" src="/js/mail/operations/ReassignMailbag_Script.jsp" />
...
<div id="divmain" class="iCargoPopUpContent" style="width=100%;height:150px;">	
...
<ihtml:hidden property="fromdestination" />
			...
			<div class="ic-border"><!-- Modified by A-8236 for ICRD-251780 -->
				...
				<div id="DESTN">
					<div class="ic-input ic-split-50 ic-mandatory">
							...
							<ihtml:text property="carrierCode" maxlength="3" tabindex="1" componentID="CMP_MAILTRACKING_DEFAULTS_REASSIGNMAILBAG_CARRIERCODE"/>
								<div class="lovImg"> <img value="carrierLOV" src="<%=request.getContextPath()%>/images/lov.png" width="22" height="22" onclick="displayLOV('showAirline.do','N','Y','showAirline.do',targetFormName.elements.carrierCode.value,'Airline','0','carrierCode','',0)"></div>
						</div>
						...
						<div class="ic-input ic-split-50 ic-mandatory">
							...
							<ihtml:text property="destination" maxlength="4" tabindex="2" componentID="CMP_MAILTRACKING_DEFAULTS_REASSIGNMAILBAG_DESTINATION" />
							<div class="lovImg">	<img value="destinationLOV" src="<%=request.getContextPath()%>/images/lov.png" width="22" height="22" onclick="displayLOV('showAirport.do','N','Y','showAirport.do',targetFormName.elements.destination.value,'Airport','0','destination','',0)"></div>
						</div>
				</div>
 ...
 <div class="ic-foot-container">
		...
		<div class="ic-button-container paddR5">
				<ihtml:nbutton property="btnOk" componentID="BTN_MAILTRACKING_DEFAULTS_REASSIGNMAILBAG_OK" tabindex="5">
					<common:message key="mailtracking.defaults.reassignmailbag.btn.ok" />
				</ihtml:nbutton>
				<ihtml:nbutton property="btnClose" componentID="BTN_MAILTRACKING_DEFAULTS_REASSIGNMAILBAG_CLOSE" tabindex="6">
					<common:message key="mailtracking.defaults.reassignmailbag.btn.close" />
				</ihtml:nbutton>
