...
* File Name			 : ReassignDSN_Ajax.jsp
* Date				 : 01-APR-2008
...
<ihtml:form action="/mailtracking.defaults.reassigndsn.screenloadreassigndsn.do" >
														...
														<tr>	 
															...
															<td class="iCargoTableDataTd" >
																<logic:present name="despatchDetailsVO" property="acceptedWeight">
																	...
																	<%--																	
																	<ihtml:text property="reAssignedWt"  value="<%=String.valueOf(sampleStdWtVo.getDisplayValue())%>" componentID="CMP_MAILTRACKING_DEFAULTS_REASSIGNDSN_REASSIGN_WT" maxlength="8"/>
																	--%>
																</logic:present>
