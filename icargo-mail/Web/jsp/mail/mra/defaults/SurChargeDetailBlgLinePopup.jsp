...
<title><common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.title" bundle="viewbillingline" scope="request" /></title>
...
<div class="iCargoPopUpContent" style="width:430px;">
 <ihtml:form action="/mailtracking.mra.defaults.viewbillingline.surchargedetails.do" styleClass="ic-main-form" >
 
 <div class="ic-content-main">
 <span class="ic-page-title ic-display-none">
				 <common:message  key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.title" />
			</span>
 <div class="ic-main-container">
		  ...
		  <table class="fixed-header-table">
				<thead>
					<tr>
						...
						<common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.surchgdetails" />
						</div>
						</td>						
					</tr>
					<tr>
						<td class="iCargoTableHeaderLabel" width="25%"><common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.chargehead" /></td>
						<td class="iCargoTableHeaderLabel" width="25%"><common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.ratingbasis" /></td>
						<td class="iCargoTableHeaderLabel" width="25%"><common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.chargetype" /></td>
						<td class="iCargoTableHeaderLabel" width="25%"><common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.ratecharge" /></td>
					</tr>
				</thead>
				<tbody>
	...
	<div class="ic-foot-container paddR5">
		<div class="ic-row">
			...
			<ihtml:nbutton property="btClose" componentID="CMP_Mailtracking_Mra_Defaults_ViewBillingLine_SurchargePopup_Close" onclick="window.close();">
				<common:message key="mailtracking.mra.defaults.viewbillingline.surchgdetailpopup.btn.btnClose" />
			</ihtml:nbutton>
			</div>
		</div>
	</div>
