...
<%@ page import="com.ibsplc.icargo.presentation.web.session.impl.mail.mra.airlinebilling.inward.AirlineExceptionsSessionImpl" %>




<bean:define id="form"
		 name="AirlineExceptionsForm"
		 type="com.ibsplc.icargo.presentation.web.struts.form.mail.mra.airlinebilling.inward.AirlineExceptionsForm"
		 toScope="page" />
...
<common:include type="script" src="/js/mail/mra/airlinebilling/inward/AcceptDSN_Script.jsp" />
...
<body id="bodyStyle">
	...
	<div class="iCargoPopUpContent" >
		<ihtml:form action="/mailtracking.mra.airlinebilling.inward.airlineexceptions.remarkspopup.do" styleClass="ic-main-form">
