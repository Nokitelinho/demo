/*
 * TxProbingWSIncomingInterceptor.java Created on 08-Jan-2016
 *
 ...
 *
 */
public class TxProbingWSIncomingInterceptor extends TxProbeWSInterceptor{
	
	public TxProbingWSIncomingInterceptor(TxProbeFacade facade) {
		super(facade, Phase.RECEIVE);
	}
