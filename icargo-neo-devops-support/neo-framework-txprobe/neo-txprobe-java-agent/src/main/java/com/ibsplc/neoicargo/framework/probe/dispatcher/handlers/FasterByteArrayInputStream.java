...
/**
 * An unsynchronized version of the ByteArrayInputStream
 * @author A-1456
 *
 */
class FasterByteArrayInputStream extends InputStream {
	 ...
	 *            the input buffer.
	 */
	public FasterByteArrayInputStream(byte buf[]) {
		this.buf = buf;
		this.pos = 0;
	 ...
	 */
	public FasterByteArrayInputStream(byte buf[], int offset, int length) {
		this.buf = buf;
		this.pos = offset;
