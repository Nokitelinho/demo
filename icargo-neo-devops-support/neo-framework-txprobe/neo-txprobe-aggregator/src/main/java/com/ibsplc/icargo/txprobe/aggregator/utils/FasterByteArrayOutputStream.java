 ...
 *
 */
public class FasterByteArrayOutputStream extends OutputStream implements ReusableOutputStream{
	...
	/* (non-Javadoc)
	 * @see com.ibsplc.icargo.txprobe.aggregator.utils.ReusableOutputStream#byteArray()
	 */
	@Override
