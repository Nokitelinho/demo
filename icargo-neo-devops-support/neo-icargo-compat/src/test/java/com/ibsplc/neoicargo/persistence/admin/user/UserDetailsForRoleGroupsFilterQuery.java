/*
 * UserDetailsForRoleGroupsFilterQuery Created on 30 Jul, 2014
 *
 ...
 *@author A-5497
 */
public class UserDetailsForRoleGroupsFilterQuery extends NativeQuery {
    ...
    public UserDetailsForRoleGroupsFilterQuery(
            UserLovFilterVO userLovFilterVO,
            String appendQuery1,
            String appendQuery2,
            String appendQuery3)
