/*
 * ListULDErrorsMapper.java Created on Jul 19, 2005
 *
 ...
 *
 */
public class ListULDErrorsMapper implements Mapper<ULDFlightMessageReconcileDetailsVO> {
 ...
 */
	public ULDFlightMessageReconcileDetailsVO map(ResultSet resultSet) throws SQLException {
		...
		detailsVO.setLastUpdateTime(new LocalDate(LocalDate.NO_STATION,Location.NONE,resultSet.getTimestamp("LSTUPDTIM")));
		detailsVO.setLastUpdateUser(resultSet.getString("LSTUPDUSR"));
		detailsVO.setUldSource(resultSet.getString("ULDSRC")); // Added by A-7978 for ICRD-238863
		
		
		log.exiting("ListULDErrorsMapper","map");
		return detailsVO;
