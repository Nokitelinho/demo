/*
 * StockListingMapper.java Created on Feb 16, 2012
 *
 ...
 *
 */
public class TransitStockListingMultiMapper implements MultiMapper {
    ...
    public List map(ResultSet rs) throws SQLException {
    	...
    	while(rs.next()) 
       {
    	...
    	transitStockVO.setTxnDate(new LocalDate(LocalDate.NO_STATION,Location.NONE, rs.getTimestamp("TXNDAT")));
    	}
    	transitStockVO.setMissingRemarks(rs.getString("MISRMK"));                
    	transitStockVO.setTxnRemarks(rs.getString("TXNRMK"));                                
    	//added as part of ICRD-15656 
    	transitStockVO.setStockHolderType(rs.getString("STKHLDTYP"));
