/*
 * LoanBorrowULDAgreementCommand.java Created onFeb 19, 2006
 *
 ...
 *
 */
public class LoanBorrowULDAgreementCommand  extends BaseCommand {
    ...
    */
    public void execute(InvocationContext invocationContext)
    	...
    	log.entering("LoanBorrowULDAgreementCommand","execute");
		...
		form.setAgreementNumber(agreementNumbers.get(0));
		
//		for setting session with screenload values
