/*
 * CloseCancelCommand.java Created on Jan 9, 2006
 *
 ...
 *
 */
public class CloseCancelCommand extends BaseCommand {
		...
		/**
		 * execute method for handling the closecancel action
    ...
    public void execute(InvocationContext invocationContext)
	 ...
	 ReservationListingSession session =
	 	...
	 	session.removeCancelReservationVO();
