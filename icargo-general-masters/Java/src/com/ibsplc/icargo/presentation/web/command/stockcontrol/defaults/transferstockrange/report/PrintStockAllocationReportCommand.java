 ...
 */
package com.ibsplc.icargo.presentation.web.command.stockcontrol.defaults.transferstockrange.report;
...
public class PrintStockAllocationReportCommand extends AbstractPrintCommand {	
		...
		public void execute(InvocationContext invocationContext)throws CommandInvocationException {	
			log.entering("PrintStockAllocationReportCommand", "-->execute<--- From Transfer Stock");
