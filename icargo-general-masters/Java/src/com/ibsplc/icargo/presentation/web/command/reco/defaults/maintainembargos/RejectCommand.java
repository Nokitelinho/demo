...
public class RejectCommand extends BaseCommand{
	...
	throws CommandInvocationException {
		...
		MessageInboxSession messageInboxSession = getScreenSession(
				WORKFLOW_MODULE_NAME, WORKFLOW_SCREEN_ID);
	    ...
	    try {		 
			 ...
			 error = new ErrorVO("embargo.reject",obj);// Saved Successfully
			...
			if ("Y".equals(maintainEmbargoForm.getIsModifyFlag())
					&& messageInboxSession.getMessageDetails() != null)
				{
