/*
 * DamageListDetailsCommand.java Created on May 5, 2008
 *
...
public class DamageListDetailsCommand  extends BaseCommand{
	    ...
	    private static final String SCREENID_MAINTAIN ="uld.defaults.maintaindamagereport";
	...
	public void execute(InvocationContext invocationContext)
        ...
        MaintainDamageReportForm masterForm =
   ...
   //     DamageChecklistMasterSession damageChecklistMasterSession  =
	//		getScreenSession(MODULE, SCREENID);
        MaintainDamageReportSession maintainDamageReportSession =
			(MaintainDamageReportSession)getScreenSession(MODULE,SCREENID_MAINTAIN);

      //  boolean[] checks = masterForm.isCheckbx();


       // damageChecklistMasterSession.removeULDDamageChecklistVO();
        String section= masterForm.getSection();
