/*
 * DeleteDestnCommand.java Created on Oct 29, 2005
 *
 ...
 *
 */
public class DeleteDestnCommand extends BaseCommand {
	...
	public void execute(InvocationContext invocationContext)
		...
		String[]destnChecked =  maintainProductForm.getDestinationCheck();
		...
		Iterator iterator = allStation.iterator();
			while(iterator.hasNext()){
				...
				if(!allVO.getIsOrigin()){
					for(int i=0;i<destnChecked.length;i++){
						if(destnChecked[i].equals(allVO.getStation())){
