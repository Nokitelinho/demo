 ...
 * 
 */
public class CloseCustomerPointsCommand extends BaseCommand {
	private Log log = LogFactory.getLogger("CloseCustomerPointsCommand");
 ...
 */
    public void execute(InvocationContext invocationContext)
            throws CommandInvocationException {
    	log.entering("CloseCustomerPointsCommand","Enter");
    	...
    	log.exiting("CloseCustomerPointsCommand","Exit");
