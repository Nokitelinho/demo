/*
 * ScreenLoadServiceMasterCommand.java  Created on May 8, 2006
 *
 ...
 * @author A-2052
 */
public class ScreenLoadServiceMasterCommand extends BaseCommand {

	private Log log = LogFactory.getLogger("ScreenLoadServiceMasterCommand");	
    ...
    */
    public void execute(InvocationContext invocationContext)
            throws CommandInvocationException {
    	log.entering("ScreenLoadServiceMasterCommand","execute");
    	...
    	form.setDescription("");
    	log.exiting("ScreenLoadServiceMasterCommand","execute");
