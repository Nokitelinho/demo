/*
 * ListLoyaltyProgrammeLOVCommand.java Created on Apr 19, 2006
 *
 ...
 *
 */
public class ListLoyaltyProgrammeLOVCommand extends BaseCommand {
    ...
    */
    public void execute(InvocationContext invocationContext)
    	...
    	loyaltyProgrammeFilterVO.setLoyaltyProgrammeCode(loyaltyProgrammeLovForm.getLoyaltyProgramName());
    	loyaltyProgrammeFilterVO.setLoyaltyDescription(loyaltyProgrammeLovForm.getLoyaltyProgramDescription());
		...
		try {
    		/*Modified by A-5220 for ICRD-32647
    		 Earlier page number is hard coded to 1. Now taking from form
    		 in delegate call
    		 */
    		
    		loyaltyProgrammeVOs = customerMgmntDefaultsDelegate.
    		listAllLoyaltyProgrammes(loyaltyProgrammeFilterVO,
    				Integer.parseInt(loyaltyProgrammeLovForm.getDisplayPage()));
...
//printStackTrrace()();
    	...
    	if(loyaltyProgrammeVOs!=null && loyaltyProgrammeVOs.size()>0)
    	{
    		...
    		maintainLoyaltySession.setLoyaltyProgrammeLovVOs(loyaltyProgrammeVOs);
    	}else{
