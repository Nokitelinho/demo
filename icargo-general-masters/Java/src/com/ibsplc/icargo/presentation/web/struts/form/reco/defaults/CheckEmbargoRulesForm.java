...
public class CheckEmbargoRulesForm extends ScreenModel {
	...
	private static final String BUNDLE 	= "embargorulesresources";
	...
	private String notocAction = "";

	public String getNotocAction() {
		return notocAction;
	}

	public void setNotocAction(String notocAction) {
		this.notocAction = notocAction;
	}
