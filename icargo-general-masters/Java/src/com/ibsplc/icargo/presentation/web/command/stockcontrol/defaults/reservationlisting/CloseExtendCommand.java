/*
 * CloseExtendCommand.java Created on Jan 9, 2006
 *
 ...
 *
 */
public class CloseExtendCommand extends BaseCommand {
		...
		/**
		 * execute method for handling the close extend action
    ...
    public void execute(InvocationContext invocationContext)
	 ...
	 session.removeExtendReservationVO();
