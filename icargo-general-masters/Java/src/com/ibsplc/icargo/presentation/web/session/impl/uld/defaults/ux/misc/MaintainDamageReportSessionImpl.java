package com.ibsplc.icargo.presentation.web.session.impl.uld.defaults.ux.misc;
...
public class MaintainDamageReportSessionImpl extends AbstractScreenSession implements MaintainDamageReportSession{
	...
	private static final String KEY_DMGREFNO = "damage_ref_no";
	...
	private static final String DAMAGECHECKLISTMAP = "damagechecklistmap";//Added by A-7924 as part of KE bug
	
	//Added by A-7636 as part of ICRD-245031
	private static final String DMG_IMG_MAP = "damageImageMap";
	private static final String DMG_IMG_LIST = "damageImageList";
	private static final String KEY_IMG_TO_REMOVE = "removeDmgImage";
	...
	public ArrayList<UploadFileModel> getDamageImageList() {
        return getAttribute(DMG_IMG_LIST);
    }
	
	public void setDamageImageList(ArrayList<UploadFileModel> damageImageList) {
    	setAttribute(DMG_IMG_LIST, damageImageList);
    }
	
   /**
	 * @return Returns the removeDmgImage.
	 */
	public ArrayList<String> getRemoveDmgImage() {
		return getAttribute(KEY_IMG_TO_REMOVE);
	}

	/**
	 * @param removeDmgImage
	 */
	public void setRemoveDmgImage(ArrayList<String> removeImageIndex) {
		setAttribute(KEY_IMG_TO_REMOVE,removeImageIndex);
	}
 ...
 */
	...
	*/
	...
	public ArrayList<Long> getDmgRefNo() {
		return getAttribute(KEY_DMGREFNO);
	}

	public void setDmgRefNo(ArrayList<Long> dmgRefNo) {
		setAttribute(KEY_DMGREFNO,dmgRefNo);
		
	}
	//Added by A-7924 as part of ICRD-297517 starts
	@Override
	public HashMap<String, Collection<ULDDamageChecklistVO>> getDamageChecklistMap() {
		return getAttribute(DAMAGECHECKLISTMAP);	}

	@Override
	public void setDamageChecklistMap(HashMap<String, Collection<ULDDamageChecklistVO>> damageCheckList) {
		setAttribute(DAMAGECHECKLISTMAP, damageCheckList);
	}	
