/*
 * ScreenLoadULDDiscrepancyReport.java Created on Mar 20, 2008
 *
 ...
 *
 */
public class ScreenLoadULDDiscrepancyReport extends BaseCommand {
	...
	private Log log = LogFactory
			.getLogger("ScreenLoadULDDiscrepancyReport");
	...
	public void execute(InvocationContext invocationContext)
			throws CommandInvocationException {
		log.entering("ScreenLoadULDDiscrepancyReport---------------->>>>",
			"Entering");
		...
		log.exiting("ScreenLoadULDDiscrepancyReport---------------->>>>",
			"Exiting");
