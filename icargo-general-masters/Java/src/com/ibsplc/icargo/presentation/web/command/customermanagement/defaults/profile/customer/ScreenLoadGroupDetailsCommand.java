 ...
 * Name       : ScreenLoadGroupDetailsCommand.java
 * Created by : A-2569
...
public class ScreenLoadGroupDetailsCommand extends BaseCommand{
	...
	public void execute(InvocationContext invocationContext)
		...
		log.entering("ScreenLoadGroupDetailsCommand","");
		ListGroupDetailsForm form = (ListGroupDetailsForm)invocationContext.screenModel;
		MaintainCustomerRegistrationSession session = getScreenSession( "customermanagement.defaults","customermanagement.defaults.maintainregcustomer");
