/*
 * RefreshGenerateInvoiceTxnCommand.java Created on Feb 19, 2006
 *
 ...
 *
 */
public class RefreshGenerateInvoiceTxnCommand  extends BaseCommand {
    ...
    */
    public void execute(InvocationContext invocationContext)
            throws CommandInvocationException {
    	log.entering("RefreshGenerateInvoiceTxnCommand","execute");
							...
							try {
								...
								if(txnListVO.getTransactionDetailsPage() != null && txnListVO.getTransactionDetailsPage().size() > 0){
							     for(ULDTransactionDetailsVO vo: txnListVO.getTransactionDetailsPage()){
									...
									//added by a-3045 for bug 17084 ends
							     ErrorVO errorVO = new ErrorVO("uld.defaults.transaction.enquirygeninvoice",
							    		 new Object[]{listULDTransactionForm.getInvoiceId()});
								 errorVO.setErrorDisplayType(STATUS);
								 errors.add(errorVO);
								 invocationContext.addAllError(errors);
