/*
 * NavigateULDDamageCommand.java Created on Aug 1, 2005
 *
...
public class NavigateULDDamageCommand extends BaseCommand{
	...
	private static final String SCREENLOAD_SUCCESS = "list_success";
    ...
    */
    public void execute(InvocationContext invocationContext)
		...
		MaintainDamageReportForm maintainDamageReportForm =
    	 ...
    	 ArrayList<String> uldNumbers = maintainDamageReportSession.getUldNumbers();
    	 log.log(Log.FINE, "Current Page--------------->", Integer.parseInt(maintainDamageReportForm.getDisplayPage()));
		String uldNumber = uldNumbers.get(Integer.parseInt(maintainDamageReportForm.getDisplayPage())-1);
    	maintainDamageReportForm.setUldNumber(uldNumber);
    	maintainDamageReportForm.setPageURL(maintainDamageReportSession.getPageURL());
