    ...
    */
    public void execute(InvocationContext invocationContext)
		...
		for(ULDDamageVO uldDamageVO:uldDamageVOs){
			...
			try {
				uldDamagePicturevo=uldDefaultsDelegate.fetchULDDamagePicture
			(compCode,uldDamageRepairDetailsVO.getUldNumber().toUpperCase(),Long.parseLong(maintainDamageReportForm.getSeqNum()),uldDamageRepairDetailsVO.getImageSequenceNumber()); 
			}
