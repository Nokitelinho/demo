/*
 * SelectRestrnDestnCommand.java Created on Oct 29, 2005
 *
 ...
 *
 */
public class SelectRestrnDestnCommand extends BaseCommand {
	 ...
	 */
		...
		if(stations!=null){ 
			Collection<RestrictionStationVO> selectedListFromLov
							= getNewlySelectedStations(stations,false,maintainProductForm);
	    ...
	    private Collection<RestrictionStationVO> getNewlySelectedStations(
	    	...
	    	for(AirportLovVO vo : stations){
	    		...
	    		if(isOrigin){
	    			String originRestriction = mintainProductForm.getOriginStatus();
