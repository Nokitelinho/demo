/*
 * StockHolderAuditVO.java Created on Jul 20, 2005
 *
 ...
 *
 */
public class StockHolderAuditVO extends AuditVO {

    /**
     * Audit Action code of inserting stockholder
     */
    public static final String STOCKHOLDER_INSERT_ACTIONCODE = "STKHLDCRT";
     ...
     * 
     */
    public static final String AUDIT_ENTITY = "stockcontrol.defaults.StockHolderAudit";
     ...
     * @param entityName
     */
    public StockHolderAuditVO(String productName, String moduleName, String entityName) {
