/*
 * AllocateStockAuditPK.java Created on Jul 20, 2005
 *
...
@KeyTable(table="STKRNGAUDKEY",keyColumn="KEYTYP",valueColumn="MAXSEQNUM")
@TableKeyGenerator(name="AUDSEQ_GEN",table="STKRNGAUDKEY",key="STKRNGAUD_SEQ")
@Embeddable
public class AllocateStockAuditPK implements Serializable {
	 ...
	 */
	public AllocateStockAuditPK(String companyCode,String stockHolderCode,long sequenceNumber){
	...
	public String toString() {
		...
		sbul.append("AllocateStockAuditPK [ ");
