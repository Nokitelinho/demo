/*
 * ULDInventoryDetailsVO.java Created on May 27, 2008
 *
 ...
 *
 */
public class ULDInventoryDetailsVO extends AbstractVO implements Serializable{
	
	private String airportCode;
	private String uldType;
	private int requiredULD;
	 ...
	 */
	public int getRequiredULD() {
		return requiredULD;
	}
	/**
	 * @param requiredULD the requiredULD to set
	 */
	public void setRequiredULD(int requiredULD) {
