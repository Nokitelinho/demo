 ...
 *
 */
public class ULDTransactionDetailsMicroVO extends AbstractVO{
...
//Stamping and Tracking Invoice
    ...
    //added for maintain uld trn screen	 AirNZ857
	...
	/**
	 * @return the uldConditionCode
	 */
	public String getUldConditionCode() {
		return uldConditionCode;
	}
	/**
	 * @param uldConditionCode the uldConditionCode to set
	 */
