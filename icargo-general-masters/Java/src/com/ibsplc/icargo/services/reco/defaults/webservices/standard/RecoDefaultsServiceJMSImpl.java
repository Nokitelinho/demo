/*
 * RecoDefaultsServiceJMSImpl.java Created on Feb 20, 2018
 *
...
portName = "RecoDefaultsServiceSOAPJMS",	
...
@Module("reco")
@SubModule("defaults")                 
public class RecoDefaultsServiceJMSImpl extends RecoDefaultsServiceBaseImpl implements RecoDefaultsService {

    private static final Logger LOG = Logger.getLogger(RecoDefaultsServiceJMSImpl.class.getName());
	...
	public EmbargoEnquiryResponseType getEmbargoEnquiryDetails(
		...
		LOG.entering("RecoDefaultsServiceJMSImpl", "getEmbargoEnquiryDetails");
		return super.getEmbargoEnquiryDetails(embargoEnquiryRequest);
	}
