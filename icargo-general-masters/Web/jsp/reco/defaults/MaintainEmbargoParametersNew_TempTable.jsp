	...
	<logic:present name="embargoVo" property="parameters">
		...
		<logic:iterate id ="embargoParameterVO" name="embargoVo" property="parameters" indexId="rowCount">
			<logic:present name="embargoParameterVO" property="parameterValues">
				...
				<logic:notPresent name="embargoParameterVO" property="operationalFlag">
					...
					<tr>
						...
						<td >
							...
							"AWBPRE".equals(parCode) || "COM".equals(parCode) || "ULDTYP".equals(parCode) || "MALCAT".equals(parCode) ||
						...
						<td>
							<% if ("FLTTYP".equals(parCode) || "CAR".equals(parCode) || "DAT".equals(parCode) || "FLTOWR".equals(parCode) || "GOODS".equals(parCode) || "PAYTYP".equals(parCode) || 
							"PRD".equals(parCode) || "ARLGRP".equals(parCode) || "UNNUM".equals(parCode) || 
							"AWBPRE".equals(parCode) || "FLTNUM".equals(parCode) || "COM".equals(parCode)|| "ULDTYP".equals(parCode)|| "MALCAT".equals(parCode) ||
							"MALCLS".equals(parCode) || "MALSUBCLS".equals(parCode) || "MALSUBCLSGRP".equals(parCode) || "PKGINS".equals(parCode) || "AGT".equals(parCode) || "AGTGRP".equals(parCode) || "ULD".equals(parCode) || "ACRTYPGRP".equals(parCode) || "ACRTYP".equals(parCode) || "SRVCRGCLS".equals(parCode) ||
							"ACRCLS".equals(parCode) || "SHP".equals(parCode) || "CNS".equals(parCode) || "SHPGRP".equals(parCode) || "CNSGRP".equals(parCode) || "SRVCTYP".equals(parCode) || "SRVCTYPFRTECSTP".equals(parCode)|| "PKGGRP".equals(parCode) || "SHPTYP".equals(parCode) || "SUBRSK".equals(parCode) ||  "CNSL".equals(parCode) ){%>
						...
						<logic:present name="embargoParameterVO" property="parameterValues">
                        <!-- <bean:define id="embargoParameterVO" name="embargoParameterVO" toScope="request"/>-->
							<%request.setAttribute("embargoParameterVO",embargoParameterVO);%>
							<jsp:include page="MaintainEmbargoParametersNew_TempTableSplit.jsp"/>
				...
				<logic:equal name="parValues" value="-">
					<tr style="display:none">
				
						<html:hidden property="paramOperationalFlag" value="DELETE"/>
						<td>
						...
						<bean:define id="parCode" name="embargoParameterVO" property="parameterCode" />
						<td >
							<% if ("CAR".equals(parCode) || "DAT".equals(parCode) || "FLTOWR".equals(parCode) || "GOODS".equals(parCode) || "PAYTYP".equals(parCode) || 
							"PRD".equals(parCode) || "UNNUM".equals(parCode) || 
							"AWBPRE".equals(parCode) || "FLTNUM".equals(parCode) || "COM".equals(parCode) || "ULDTYP".equals(parCode) || "MALCAT".equals(parCode) ||
							"MALCLS".equals(parCode) || "MALSUBCLS".equals(parCode) || "MALSUBCLSGRP".equals(parCode) || "AGT".equals(parCode) || "AGTGRP".equals(parCode) || "ULD".equals(parCode) || "ACRTYPGRP".equals(parCode)
		
									|| "ACRTYP".equals(parCode)  || "SRVCRGCLS".equals(parCode)  || "ACRCLS".equals(parCode) || "SHP".equals(parCode) || "CNS".equals(parCode) || "SHPGRP".equals(parCode) || "CNSGRP".equals(parCode) || "SRVCTYP".equals(parCode) || "SRVCTYPFRTECSTP".equals(parCode) || "PKGGRP".equals(parCode) ||  "SHPTYP".equals(parCode) || "SUBRSK".equals(parCode) ||  "CNSL".equals(parCode)|| "FLTTYP".equals(parCode)){%><!-- Added by 202766 for IASCB-159851 -->
						...
						<logic:present name="embargoParameterVO" property="parameterValues">
							...
							<td>
								<logic:present name="embargoParameterVO" property="applicableLevel">
									...
									|| "ARLGRP".equals(parCode) || "ACRTYPGRP".equals(parCode) || "ACRTYP".equals(parCode) || "ACRCLS".equals(parCode)){%>
