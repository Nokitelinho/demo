...
<business:sessionBean id="subRisk" moduleName="reco.defaults" screenID="reco.defaults.maintainembargo" method="get" attribute="subRisk" />
							...
							<%EmbargoParameterVO embargoParameterVO=(EmbargoParameterVO) request.getAttribute("embargoParameterVO");%>
							...
							<td>
								<div class="column4_control_div ic-input">
									...
									<% if ("CAR".equals(parCode)){%>
										<ihtml:text property="carrier" value="<%=(String)parameterValues %>"  componentID="CMP_Reco_Defaults_MaintainEmbargo_Filter_Carrier"  onblur="restrictValues(this);" />
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="16" onclick="displayLOV('showAirline.do','Y','Y','showAirline.do',carrier,'carrier','1','carrier','',0,null,null,null,null,10);" height="22" id="carrier"/></div>		
									...
									<ihtml:text property="dates" value="" componentID="CMP_Reco_Defaults_MaintainEmbargo_Filter_Dates" onblur="restrictValues(this);" onchange="dateCheck(this);"/><common:message  key="maintainembargo.dateformat"/>
									...
									<ihtml:text property="time" value="" componentID="CMP_Reco_Defaults_MaintainEmbargo_Time" onchange="validateTime(this);"/><common:message  key="maintainembargo.timeformat"/>
									...
									<% }else if ("COM".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="16" onclick="displayLOV('showCommodity.do','Y','Y','showCommodity.do',commodity,'commodity','1','commodity','',0,null,null,null,null,10);" height="16" id="commodity"/></div>																			
									<% }else if ("ULD".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="16" onclick="displayLOV('shared.uld.findUldTypeAndGroup.do','N','Y','shared.uld.findUldTypeAndGroup.do',uldType,'uldType','1','uldType','',0,null,null,null,null,10);" height="16" id="uldType"/></div>																			
									
									<% }else if ("ULDTYP".equals(parCode)){%>
										<ihtml:text property="uldTyp" value="<%=(String)parameterValues %>" onblur="restrictValues(this);"  componentID="CMP_Reco_Defaults_MaintainEmbargo_Filter_Commodity" />
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="16" onclick="displayLOV('showUld.do','N','Y','showUld.do',uldTyp,'uldTyp','1','uldTyp','',0,null,null,null,null,10);" height="16" id="uldTyp"/></div>																			
									
									<% }else if ("FLTNUM".equals(parCode)){%>
											<%
											EmbargoParameterVO embargoParVO = (EmbargoParameterVO) request.getAttribute("embargoParameterVO");
											String carrierCode = "";
									...
									<% }else if ("FLTOWR".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="20" height="20" id="flghtOwnr"  class="flghtOwnr"  onclick="displayLOV('showAirline.do','Y','Y','showAirline.do',flightOwner,'Airline','1','flightOwner','',0,null,null,null,null,10);"/></div>
									...
									<% }else if ("SCCGRP".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.gif" width="20" onclick="showParameterGroupLov('shared.generalmastergrouping.screenloadgroupnamelov.do','N',sccGroup,'SCCGRP','EMB','sccGroup','1',0);" height="20" id="sccGroup"/></div>
									<% }else if ("ARLGRP".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.png" width="20" onclick="showParameterGroupLov('shared.generalmastergrouping.screenloadgroupnamelov.do','N',airlineGroup,'ARLGRP','EMB','airlineGroup','1',0);" height="20" id="airlineGroup"/></div>
									<% }else if ("ACRTYPGRP".equals(parCode)){%>
										...
										<div class= "lovImgTbl"><img src="<%=request.getContextPath()%>/images/lov.png" width="20" onclick="showParameterGroupLov('shared.generalmastergrouping.screenloadgroupnamelov.do','N',aircraftGroupType,'ACRTYPGRP','EMB','aircraftGroupType','1',0);" height="20" id="aircraftGroupType"/></div>
								...
								<% }else if ("ACRCLS".equals(parCode)){%>
									<ihtml:text property="aircraftClassification" value="<%=(String)parameterValues %>"   componentID="CMP_Reco_Defaults_MaintainEmbargo_Filter_AircraftClassification" />
									...
									<% }else if ("SRVCTYPFRTECSTP".equals(parCode)){%>
										<ihtml:select property="serviceTypeForTechnicalStop" value="<%=(String)parameterValues %>"  componentID="CMP_Reco_Defaults_MaintainEmbargo_Filter_ServiceTypeForTechnicalStop" onblur="restrictValues(this);"  multiSelect="true" multiSelectNoneSelectedText="Select" multiSelectMinWidth="180" multiple="multiple">
											<logic:present name="serviceTypeForTechnicalStop">
												<logic:iterate id="srvcTypFrTecStp" name="srvcTypFrTecStp">
