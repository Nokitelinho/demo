...
<div id="parameter_control_" class="parameter_control" style="display:none">
								...
								<ihtml:text property="defaultText"  onblur="restrictValues(this);" onkeyup="validateaplphanum(this);" componentID="CMP_Reco_Defaults_ListEmbargo_Filter_Default_Text" />
							</div>
