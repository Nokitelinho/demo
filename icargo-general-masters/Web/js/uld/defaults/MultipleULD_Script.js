...
function onScreenLoad(){
	...
	if(statusFlag == "save") {
		...
		if(targetFormName.elements.structuralFlag.value=="firstOk" ) {
			...
			window.opener.targetFormName.action="uld.defaults.createnewuld.do?uldType="+uldType+"&ownerAirlineCode="+ownerAirlineCode+"&structuralFlag="+structuralStatus;
			window.opener.targetFormName.submit();
			close();
		}
		else {
			window.opener.targetFormName.action="uld.defaults.refreshmaintainuld.do?uldType="+uldType+"&ownerAirlineCode="+ownerAirlineCode+"&structuralFlag="+structuralStatus;
			window.opener.targetFormName.submit();
			close();
		}
	}
